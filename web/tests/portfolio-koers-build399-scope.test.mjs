...
const allowed=new Set([
  ...
  "web/tests/portfolio-koers-build399-scope.test.mjs",
...
test("Build 399 is display-only and touches no trading, dataflow, auth or PWA files",(t)=>{
  if(currentBuild()!=="399")return t.skip("Build-specific guard");
  ...
  assert.deepEqual(unexpected,[],`Build 399 touched non-display scope: ${unexpected.join(", ")}`);
});
