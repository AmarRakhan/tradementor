...
const allowed=new Set([
  ...
  "web/tests/portfolio-koers-build401-scope.test.mjs",
...
test("Build 401 stays display-only and cannot alter zone detection, dataflow or trading",(t)=>{
  if(currentBuild()!=="401")return t.skip("Build-specific guard");
  ...
  assert.deepEqual(unexpected,[],`Build 401 touched non-display scope: ${unexpected.join(", ")}`);
});
