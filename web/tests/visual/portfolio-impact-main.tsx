...
type PressureFixture = Record<"1m" | "5m" | "15m" | "1h" | "4h" | "24h", number>;
...
const basePressure: PressureFixture = {
  "1m": -82,
  "5m": -64,
  "15m": -42,
  "1h": 2,
...
function Fixture() {
  const [pressure, setPressure] = useState<PressureFixture>({ ...basePressure });
