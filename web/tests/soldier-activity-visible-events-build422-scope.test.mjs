...
const allowed=new Set([
  ...
  "web/tests/soldier-activity-visible-events-build422-scope.test.mjs",
...
test("Build 422 stays frontend/read-only and touches no trading backend API auth or PWA files",(t)=>{
  if(currentBuild()!=="422")return t.skip("Build-specific guard");
  ...
  assert.deepEqual(unexpected,[],`Build 422 touched non-read-only scope: ${unexpected.join(", ")}`);
});
