...
test("shared v44 testapp has one canonical Cloud Run service", () => {
...
test("shared v44 testapp reads the production Aster status directly", () => {
...
test("shared v44 PWA contract stays pinned to version 44", () => {
  assert.match(serviceWorker, /amar-bot-shell-v44/);
});
