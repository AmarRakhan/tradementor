...
import { AsterStrategy2QuickControl } from "@/components/aster-strategy2-quick-control";
...
import { AsterStrategy3RapidBuild } from "@/components/aster-strategy3-rapid-build";
...
export function AsterPerformancePanel({ snapshot, onChanged }: { snapshot: Record<string, unknown> | null; onChanged: () => void }) {
  ...
  return <section className="aster-performance">
    ...
    <AsterStrategy2QuickControl snapshot={snapshot} onChanged={onChanged} />
    <AsterStrategy2Behavior snapshot={snapshot} onChanged={onChanged} />
    <AsterStrategy3Control snapshot={snapshot} onChanged={onChanged} />
    <AsterStrategy3RapidBuild snapshot={snapshot} onChanged={onChanged} />
