...
export type VerifiedTradeEvent={id:string;side:"LONG"|"SHORT";kind:"entry"|"dca"|"close";action:"increase"|"close";price:number;at:string;timestampMs:number;quantity?:number;notional?:number;dcaNumber?:number;realizedPnl?:number;exchange?:string};
