...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  problems: [
    "Portfolio TP kon alleen procentueel worden ingesteld en rekende altijd vanaf de bestaande cycle start, ook wanneer die ver boven de actuele equity lag.",
    "De drie Take Profit-modusknoppen waren visueel te gelijk, waardoor niet duidelijk genoeg was welke modus actief stond.",
  ],
  causes: [
  ...
  fixes: [
    ...
    "Huidige waarde wordt server-side één keer vastgezet per opgeslagen configuratie en schuift daarna niet mee met live equity.",
    "Na een succesvolle Portfolio TP wordt de werkelijke post-close equity de nieuwe cycle start en begint de volgende cycle automatisch.",
    "De bestaande idempotente close-flow, partial-fill recovery en Strategy-2 orderlocks blijven leidend.",
  ],
  now: [
    "Een portfolio van $92,27 met 2,00% en basis Huidige waarde toont een doel van $94,12.",
    "Een portfolio van $92,27 met +$5,00 toont een doel van $97,27.",
    "Cycle start, actuele equity, gebruikte basis en target staan tegelijk zichtbaar in het nieuwe Portfolio TP-overzicht.",
  ],
  before: "Portfolio TP was uitsluitend X% vanaf de bestaande cycle start en de actieve Take Profit-tab was onvoldoende onderscheidend.",
  after: "Portfolio TP ondersteunt %/$, drie basiskeuzes, veilige cycle reset, automatische post-close cycli en een duidelijke actieve tabstate.",
  technicalDetails: [
    "Visuele referentie: file_00000000f6e08210b726c694adc15111.",
    "Reset cycle gebruikt een read-only Aster client en heeft een expliciet ordersSent=0 contract.",
    "Technische simulatie/backtest controleert meerdere opeenvolgende percentage- en dollarcycli zonder rendement te voorspellen.",
  ],
