...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "LONG/SHORT entries gebruiken compacte groene/rode soldaat-iconen met alleen een kleine ×n-multiplier.",
    "Take Profit gebruikt standaard een geldzak-icoon; grote TP/Entry-teksten en dollarbedragen zijn uit de normale markerweergave verwijderd.",
    "De rechter prijsas reserveert nog 48px in plaats van 70px en de mobiele kaartpadding is verkleind, zodat meer breedte voor de koers beschikbaar is.",
    "Iedere opening start deterministisch in de goedgekeurde 15m-weergave met een timeframe-specifieke zichtbare range in plaats van een oude opgeslagen zoom/timeframe te herstellen.",
  ],
  problems: [
    "Eventkaartjes konden Bollinger Bands en candles visueel blokkeren en entry-notional leek op een portfoliowaarde.",
    "De prijsas stond mobiel te ver naar links en fitContent kon bij openen een te druk of te ver uitgezoomd beeld geven.",
    "Tekstlabels zoals Entry L/Entry S/TP waren te dominant ten opzichte van candles en Bollinger.",
  ],
  causes: [
    "De marker-layout controleerde onderlinge collisions maar kende de actuele bovenste/onderste Bollinger-coördinaten niet.",
    "De chart reserveerde 70px voor de prijsas en herstelde een lokaal opgeslagen timeframe voordat fitContent alle historie in beeld probeerde te zetten.",
  ],
  fixes: [
    "De marker-layout ontvangt per event de echte Bollinger-top/bottom in pixelcoördinaten en accepteert alleen labels die volledig buiten de envelope passen.",
    "Een subtiele kleur-dot bij de candle blijft als anker; het compacte icoon staat buiten de Bollinger-envelope.",
    "Standaardmarkers bevatten geen dollarbedrag; notional, realized PnL en transferbedragen blijven uitsluitend in de crosshair/tap-tooltip beschikbaar.",
    "Per timeframe is een eigen openingsrange ingesteld voor duidelijk verschil tussen 1m, 5m, 15m, 1u, 4u en 24u.",
  ],
  now: [
    "Candles en Bollinger Bands zijn de dominante informatielaag; trade-events zijn compacte context.",
    "De chart opent direct op 15m zonder vooraf handmatig scrollen, in-/uitzoomen of een oude lokale timeframevoorkeur te herstellen.",
    "Event timestamps, counts, notional, realized PnL, candles, equity, zones, Bollinger-berekening en backenddata zijn ongewijzigd.",
  ],
  before: "Build 399 gebruikte nog tekst-/kaartachtige eventlabels, 70px prijsasruimte en collision-layout zonder harde Bollinger-envelopegrens.",
  after: "Build 400 gebruikt icon-first markers buiten de Bollinger Bands, een 48px prijsas en een vaste rustige 15m-openingsview.",
  technicalDetails: [
    "Display-only scope: Portfolio Koers component/CSS, pure marker-layouthelper, regressietests en release/version metadata.",
    "Geen backend, API, polling, realtime equity merge, Portfolio Snapshot, auth, PWA, order-, DCA-, hedge-, TP-, leverage- of exchange-executionlogica gewijzigd.",
    "Visuele referenties: file_00000000586481fdb64073c987fabd90 en file_00000000792881f581a2e8c8d448b415.",
  ],
