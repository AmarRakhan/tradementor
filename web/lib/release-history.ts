...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Alle BETA-timeframes gebruiken nu dezelfde canonieke 15m-zonebron voor de gekleurde prijszones en de koersinstructie.",
    "4u en 24u vallen daardoor niet meer terug naar ZONE — wanneer hun eigen timeframe te weinig bevestigde swingzones heeft.",
    "De instructiebalk onderscheidt voortaan zone-synchronisatie van ontbrekende stoeldata.",
  ],
  problems: [
    "In Build 406 werkte de volledige zone-engine op 15m, maar 4u kon nog geen ladder bouwen wanneer de 4u-backend geen bevestigde zones had.",
    "Daardoor toonde 4u ZONE — en Live stoelbezetting wordt geladen terwijl de stoelbezetting 60L/30S wel degelijk beschikbaar was.",
  ],
  causes: [
    "De BETA-ladder werd nog per geselecteerd chart-timeframe gevoed. Timeframes met weinig bevestigde swingpunten konden daardoor een lege zonebron opleveren.",
  ],
  fixes: [
    "Na bevestiging van het BETA-account wordt apart de bestaande 15m Portfolio Koers-zonepayload geladen en als canonieke zonebron gebruikt.",
    "1m, 5m, 15m, 1u, 4u en 24u gebruiken vervolgens dezelfde -3 t/m +3 ladder; alleen candles, Bollinger Bands en zichtbare historie blijven timeframe-specifiek.",
    "Als de canonieke zonefetch tijdelijk niet lukt, valt de UI veilig terug op de zonebron van het huidige timeframe zonder de soldateninstellingen uit te schakelen.",
  ],
  now: [
    "Dezelfde portfolio-equity krijgt op ieder timeframe dezelfde actieve zone en dus dezelfde LONG/SHORT-instructie.",
    "Op 4u blijven de zonekleuren over de volledige hoogte zichtbaar, ook wanneer 4u zelf onvoldoende swingzones heeft.",
    "De soldatenknop blijft ongewijzigd: alleen server-side stoelcapaciteit wordt aangepast; geen directe order of geforceerde close.",
    "De wijziging blijft uitsluitend zichtbaar voor het BETA-owner account.",
  ],
  before: "Build 406 maakte de zonegeometrie volledig en extrapoleerde buiten bevestigde banden, maar gebruikte nog een zonebron per timeframe.",
  after: "Build 407 scheidt timeframe-weergave van strategische zone-indeling: één zonekaart, meerdere kijkvensters.",
  technicalDetails: [
    "Canonieke BETA-zonebron: GET /api/exchanges/aster/portfolio-chart?timeframe=15m&limit=320.",
    "De geselecteerde timeframe bepaalt nog steeds candles, Bollinger Bands, markers en tijdas.",
    "BETA-gate blijft /api/releases/me channel=BETA met bot_configurator_v2.enabled=true.",
