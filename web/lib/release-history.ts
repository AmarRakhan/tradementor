...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Portfolio Koers gebruikt nu de compacte blauw-neon tradingkaart uit de goedgekeurde referentie met titel, Live-badge, subtitle, timeframes en fullscreen in één header.",
    "Bestaande bevestigde Aster-equityhistorie uit dezelfde browser wordt veilig als displayhistorie samengevoegd met de serverpersistente candles, zodat de grafiek direct meer echte candles kan tonen zonder waarden te verzinnen.",
    "Bevestigde Entry/TP/transfer-events krijgen compacte gekleurde labels boven of onder de bijbehorende candle.",
    "Bollinger 20,2 gebruikt een blauwe bovenband, lichte gestreepte middenlijn en rode onderband; de TradingView-attributielogo-overlay is uitgeschakeld.",
    "Portfolio Snapshot toont extra contextregels voor actuele groei, LONG/SHORT-verdeling en resultaten van vandaag; de Portfolio Cyclus-knop Instellen blijft op mobiel zichtbaar.",
  ],
  problems: [
    "Build 394 was functioneel correct maar leek visueel nog duidelijk niet op de eerder goedgekeurde referentie.",
    "De chart was te hoog, gebruikte een goud/groene kaartstijl, toonde een grote actuele waarde in de header en kon bij een nieuw opgebouwde serverhistorie slechts enkele candles laten zien.",
    "Bollinger- en eventinformatie was te subtiel en de standaard chart-attributie verscheen als grijs TV-logo in de plot.",
  ],
  causes: [
    "De eerste implementatie prioriteerde veilige datakoppeling boven exacte visuele parity.",
    "De nieuwe serverpersistente equitycollectie begon pas vanaf ingebruikname op te bouwen, terwijl de app lokaal al langer bevestigde Aster-equityhistorie bewaarde.",
  ],
  fixes: [
    "Chart-layout, kleuren, verhoudingen, toolbar en plotframe zijn opnieuw opgebouwd vanuit de goedgekeurde referentie.",
    "Alleen echte lokale Aster-equitymetingen worden als oudere displaycandles geaggregeerd; servercandles blijven leidend wanneer beide dezelfde tijdsbucket bevatten.",
    "Eventlabels worden uitsluitend uit bevestigde backendmarkers opgebouwd; er worden geen voorbeeldtransacties of voorbeeldbedragen gegenereerd.",
    "Snapshot-details gebruiken bestaande live waarden en veranderen geen tradinglogica.",
  ],
  now: [
    "De kaart sluit visueel veel dichter aan op de beloofde Portfolio Koers-referentie terwijl live data en echte historie leidend blijven.",
    "Als een gebruiker geen oudere browserhistorie heeft, groeit de grafiek nog steeds uitsluitend met echte nieuwe serverbevestigde candles.",
  ],
  before: "De functionele Build 394 had een andere kaartstijl, zeer grote plot en weinig zichtbare historie/overlays.",
  after: "Build 395 gebruikt de goedgekeurde compacte tradinglook en benut bestaande echte Aster-historie zonder synthetische candles of markers.",
  technicalDetails: [
    "Frontend: portfolio-koers-chart.tsx, portfolio-koers-chart.mjs, portfolio-koers-chart.css, Portfolio Snapshot detailpresentatie en Cycle mobile layout.",
    "Geen order-, DCA-, hedge-, leverage-, TP- of backend trading-executionlogica gewijzigd.",
  ],
