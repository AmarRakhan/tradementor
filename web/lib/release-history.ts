...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Nieuw hoofdtabblad FRIENDS met mobiele ranking, traderprofielen, statistieken, instellingen, strategieën en Vergelijk & leer.",
    "Friends toont genormaliseerd rendement naast een reproduceerbare 0–10 risicoscore met leverage-, DCA-, positie-opbouw-, protection- en historische componenten.",
    "Traderinstellingen worden privacy-safe gedeeld: structurele parameters en verhoudingen zijn zichtbaar, absolute portfolio-, balance-, notional- en PnL-dollarwaarden niet.",
    "Community Insights laat ingelogde gebruikers korte trading-inzichten delen zonder een volledig sociaal netwerk toe te voegen.",
  ],
  problems: [
    "De vier actieve gebruikers konden elkaars aanpak nog niet vergelijken zonder absolute bedragen of losse screenshots.",
    "Alleen rendement vergelijken kan een agressievere setup aantrekkelijk laten lijken zonder zichtbaar te maken welk drawdown-, leverage- of DCA-risico daarvoor wordt genomen.",
  ],
  causes: [
    "Er bestond nog geen community-analyticslaag bovenop de reeds opgeslagen genormaliseerde portfoliogroei en strategie-instellingen.",
    "Risico-informatie was verspreid over individuele instellingen en historische accountdata en had nog geen consistente communityscore.",
  ],
  fixes: [
    "Nieuwe read-only Friends API gebruikt uitsluitend opgeslagen Firestore-evidence en doet geen extra exchange-polling.",
    "Publieke trader-ID's zijn gehasht; e-mail, Firebase UID, walletgegevens, credentials, equity, available balance en exacte dollar-PnL verlaten de Friends API niet.",
    "De Friends risicoscore wordt uitsluitend server-side berekend en is deterministisch voor dezelfde input.",
    "De mobiele presentatielaag volgt de vier goedgekeurde Friends-referentiebeelden en toont ranking alleen voor genormaliseerde performance; risicometrics blijven beschrijvend.",
  ],
  now: [
    "Friends → ranking → trader → Overzicht/Statistieken/Instellingen/Strategieën → Vergelijk met jouw setup werkt zonder full-page refresh.",
    "1D, 7D, 30D en Alles gebruiken dezelfde opgeslagen procentuele rendementsevidence; ontbrekende data verschijnt als Nog onvoldoende data.",
    "Trading-, DCA-, TP-, SL-, ownership-, scheduler- en orderexecutionlogica zijn niet gewijzigd.",
  ],
  before: "Build 426 maakte Portfolio Koers trade-events vrijwel realtime zichtbaar.",
  after: "Build 427 voegt een privacy-safe leerlaag toe waarin rendement altijd samen met risico kan worden beoordeeld.",
  technicalDetails: [
    "Referentie A: file_00000000482c820eb79648deaf26728b · e319405b-1385-4db6-a1ce-b24595e91366.",
    "Referentie B: file_0000000020e881f7a6b8ed2dbcb30de1 · f2917f9c-e5c1-4358-9ce6-3524d76f73d4.",
    "Referentie C: file_00000000c5d0820ea69cedf6cfd83029 · adf534c8-6fe4-484d-adaa-288160e5420e.",
    "Referentie D: file_00000000ff74820bb4f33e59ac402422 · 129eb42f-8cfe-40ca-8641-5f0592fe3155.",
    "Friends analytics cache: 30 seconden; geen exchange API-call in Friends routes.",
  ],
...
const HISTORICAL_RELEASES: ReleaseHistoryEntry[] = [
  {
    id: "v46-build-426-realtime-portfolio-events",
    version: "46",
    build: "426",
    releasedAt: "2026-09-25",
    title: "Portfolio Koers · trade-events vrijwel direct zichtbaar",
    newItems: [
      "Aparte lichte live-eventfeed voor bevestigde Strategy-2 entries, DCA's en TP's.",
      "Confirmed events worden iedere 5 seconden in de bestaande Portfolio Koers-chart gemerged zonder zware fill-history opnieuw op te halen.",
    ],
    problems: ["Aster kon een fill melden terwijl de 1m Portfolio Koers-marker door de history-cache nog niet zichtbaar was."],
    causes: ["De chart gebruikte de zwaardere cached fill-history als primaire eventbron."],
    fixes: ["Confirmed Strategy-2 audit-events kregen een aparte read-only eventfeed en deduplicatie met duurzame fillmarkers."],
    now: ["Recente confirmed trade-events verschijnen vrijwel direct terwijl de bestaande veilige exchange-cache intact blijft."],
    confidence: "confirmed",
  },
