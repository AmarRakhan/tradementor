...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    ...
    "Ultra Rivalry verandert uitsluitend de ASTER-presentatielaag en gebruikt dezelfde bestaande Portfolio Snapshot-, Portfolio Impact-, Tradecentrum- en navigatiecomponenten.",
  ...
  problems: [
    "Gebruikers wilden een uitgesproken ASTER battle-thema zonder functionele afwijking in knoppen, data of handelsgedrag.",
  ...
  fixes: [
    ...
    "Alle operationele Ultra Rivalry CSS is gescopeerd op data-app-skin=ultra-rivalry én de bestaande data-aster-compact-snapshot ASTER-flag, zodat andere hoofdtabbladen niet worden gerestyled.",
  ...
  before: "Build 423 maakte de zoneformatie hard en voegde winst-homecomings toe; de bestaande skins hadden nog geen Ultra Rivalry ASTER-presentatie.",
  after: "Build 424 voegt uitsluitend een optionele ASTER skin toe bovenop dezelfde bestaande componenten en handlers.",
  technicalDetails: [
    ...
    "Implementatie: page.tsx breidt alleen AppSkin/persistence/selector uit; ultra-rivalry.css bevat ASTER-only visuele overrides.",
    "Geen backend-, API-, trading-engine-, order-, scheduler- of exchangebestand gewijzigd voor deze theme-release.",
  ],
