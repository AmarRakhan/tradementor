...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Portfolio Koers houdt bij het laden dezelfde heldere candle- en Bollingerweergave; asynchrone zone-data werkt alleen de overlays bij en bouwt de chart niet opnieuw op.",
    "De Zone-Soldatenstatus onder de grafiek is vervangen door een compacte strategy cockpit in dezelfde premium designfamilie als Portfolio Snapshot.",
    "Automatische exposure-refill legt nu expliciet uit dat het een losse, optionele Bollinger-versnelling is en toont UIT, stand-by of de versnelde zijde op basis van opgeslagen runtime-state.",
  ],
  problems: [
    "Na de eerste duidelijke chartweergave kon de async zone-advisor een tweede volledige chartrender veroorzaken, waardoor de gebruiker een korte duidelijke flits zag en daarna een drukkere eindsituatie.",
    "De Build-408 zonekleuren waren te dekkend en konden bij uitzoomen als grote massieve kleurvlakken over de koersstructuur liggen.",
    "Koersinstructie was uitgegroeid tot een technisch tekstblok dat niet aansloot bij de scanbare Portfolio Snapshot-stijl.",
    "De generieke exposure-refill en de eigen Zone-Soldaten exposure-balancer waren in de instellingen te makkelijk met elkaar te verwarren.",
  ],
  causes: [
    "De chart-creatie-effecten waren direct afhankelijk van later binnenkomende advisorZoneLadder- en activeZone-state.",
    "Zonebanden gebruikten hoge achtergronddekking terwijl hun verticale hoogte door de actuele prijsschaal wordt bepaald.",
    "Technische zone-, formatie-, exposure- en legacygegevens werden visueel in één doorlopend informatieblok getoond.",
  ],
  fixes: [
    "Advisor-zone en actieve zone worden via live refs in de bestaande chart gesynchroniseerd; de chart zelf wordt alleen opnieuw opgebouwd wanneer echte chartdata/timeframe verandert.",
    "Zonebanden zijn teruggebracht naar subtiele transparante prijsbanden met lichte grenslijnen en een rustige actieve-zone-accentlijn.",
    "Koersinstructie is vervangen door status, hoofdactie, actieve zone, formatie, balans en volgende-zone tiles met een compacte progressmeter.",
    "Exposure-refill toont menselijk leesbare helpertekst: geen extra slots/soldaten, geen zone-capaciteitsbypass en wijzigingen worden pas actief na Opslaan.",
  ],
  now: [
    "De definitieve Portfolio Koers blijft visueel dicht bij de heldere eerste chartweergave terwijl zonegrenzen en soldateninformatie beschikbaar blijven.",
    "De gebruiker ziet direct of de Zone-Soldatenstrategie ACTIEF, WACHTEND, BALANS NODIG, DRAINING of INFORMATIEF is en wat de eerstvolgende actie is.",
    "Een opgeslagen exposure-refill UIT blijft UIT; alleen een expliciet opgeslagen AAN kan de ontbrekende zijde tijdelijk het snelle Bollinger-timeframe geven.",
  ],
  before: "Build 419 maakte de eerste expliciete Zone-Soldaten-opt-in veilig, maar de chart-overlay, koersinstructie en exposure-refill-uitleg waren nog onvoldoende rustig en onderscheidend.",
  after: "Build 420 houdt chart en overlays gescheiden, presenteert de strategie als compacte cockpit en maakt de twee verschillende exposure-mechanismen zichtbaar onderscheidbaar.",
  technicalDetails: [
    "Frontend chart lifecycle: advisor updates muteren alleen overlay-layout via refs; geen tweede Lightweight Charts instance door async zone-advisor-state.",
    "De bestaande order-, DCA-, TP/SL-, exchange- en position-ownershiplogica is niet gewijzigd.",
    "De bestaande backend bewaakt exposure-refill al als timeframe-selectie voor de onderwogen zijde; in zone-mode blijft nieuwe capaciteit uitsluitend uit beschikbare zone-owned soldiers komen.",
    "Referenties: file_000000005d5c81f5bd8239601bc774af, file_000000002ca8820ea40ab4454a53453d, file_00000000d39481f9a55e4bfdf9207323, file_0000000056248210aed2be6d8a8821cf en file_000000007ec8820b89e349bf1318c35e.",
  ],
