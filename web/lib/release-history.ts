...
const HISTORICAL_RELEASES: ReleaseHistoryEntry[] = [
  {
    ...
    newItems: [
      "Owner-only App kosten & betalingen op HOME met providerstatus en read-only Bybit betaalreserve.",
      "Google Cloud billing/budgetcontrole en appstartmeldingen zonder trading-mutaties.",
    ],
    problems: ["Continuïteitskosten en providerstatus waren nog niet centraal zichtbaar."],
    causes: ["Er bestond nog geen gescheiden read-only continuïteitsdomein naast de trading runtime."],
    fixes: ["Dedicated continuity API, owner-gate en read-only Bybit-koppeling toegevoegd."],
    now: ["Continuïteitsbewaking staat los van trading en bewaart geen Bybit-secret in browserresponses."],
    before: "Build 417 maakte Zone-Soldaten expliciet opt-in.",
    after: "Build 418 voegde een losstaande owner-only continuïteitslaag toe.",
    technicalDetails: ["Geen order-, DCA-, TP/SL-, zone-, soldier-, scanner-, leverage- of Close All-mutatiepad toegevoegd."],
    confidence: "confirmed",
  },
  {
