...
const HISTORICAL_RELEASES: ReleaseHistoryEntry[] = [
  {
    id: "v46-build-381-portfolio-tp2",
    version: "46",
    build: "381",
    releasedAt: "2026-09-20",
    title: "Portfolio Take Profit 2.0",
    newItems: [
      "Portfolio Take Profit kan als percentage of vast dollar-winstbedrag worden ingesteld.",
      "Berekeningsbasis: Cycle start, vastgezette huidige waarde of aangepaste basiswaarde.",
      "Reset cycle wijzigt alleen de Portfolio TP-cycle start en verstuurt nul orders.",
    ],
    problems: ["Portfolio TP kende voorheen alleen een procentuele doelstelling vanaf de bestaande cycle start."],
    causes: ["De eerdere configuratie kende alleen portfolioTpPercent en cycleStartEquity."],
    fixes: ["Persistente %/$ input, basiskeuze, veilige cycle reset en automatische post-close cycle toegevoegd."],
    now: ["Build 381 is de directe productievoorganger van SNIPER Live Trading."],
    confidence: "confirmed",
  },
  {
