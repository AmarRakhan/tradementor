...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    ...
    "Na een exchange-bevestigde TP in de eigen actieve zone wordt dezelfde ZONE_BASE-soldaat opnieuw AVAILABLE voor een latere geldige entry.",
    "Winst thuisgekomen telt uitsluitend een winstgevende oude-zone soldaat waarvan originZone aantoonbaar verschilt van currentZoneAtClose.",
    "Een vrijgekomen soldaat mag nooit opnieuw instappen in dezelfde reconciliation tick; de volgende normale scanner-evaluatie is vereist.",
  ],
  problems: [
    "Build 423 registreerde iedere winstgevende Zone-Soldaat-TP als homecoming, ook wanneer de positie gewoon in zijn eigen actieve zone werd gesloten.",
    "De TP-flow verwijderde ownership-state maar zette de permanente soldaatcapaciteit niet expliciet in dezelfde close-transactie terug naar AVAILABLE of DORMANT.",
    "Een direct vrijgegeven soldaat kon zonder extra guard theoretisch later in dezelfde tick opnieuw als entrycapaciteit verschijnen.",
  ],
  causes: [
    "Homecoming-events misten currentZoneAtClose en konden daardoor normale same-zone winst niet onderscheiden van een echte terugkeer uit een oudere zone.",
    "Vrijgave werd vooral via de volgende reconciliation afgeleid in plaats van direct als expliciete soldier lifecycle-transitie.",
  ],
  fixes: [
    "zoneSoldierState schemaVersion 3 accepteert alleen TP_WIN_OUTSIDE_ORIGIN_ZONE met bekende, verschillende originZone en currentZoneAtClose.",
    "Same-zone TP zet dezelfde basis-soldaat direct terug op AVAILABLE en schrijft geen homecoming-event.",
    "Outside-origin TP zet de oude-zone soldaat op DORMANT en schrijft idempotent één bewezen homecoming-event.",
    "Legacy Build-423 TP_WIN-events zonder bewijs van een andere close-zone worden conservatief niet meer als echte thuiskomst geteld.",
    "De bestaande Bollinger candidate- en pre-orderfilters blijven ongewijzigd onderdeel van iedere nieuwe missie.",
  ],
  now: [
    "Een actieve zone kan dezelfde soldaten steeds opnieuw inzetten nadat zij binnen die zone winst hebben gepakt.",
    "Vastgelopen oude-zone posities blijven open en beheerd; een nieuwe zone krijgt onafhankelijk zijn volledige vaste formatie.",
    "Exposure balancing blijft PRIORITY_ONLY en kan geen extra capaciteit creëren.",
    "Het Command Center maakt nu expliciet onderscheid tussen normale winstmissies en oude-zone soldaten die werkelijk met winst thuiskomen.",
  ],
  before: "Build 424 voegde alleen het ASTER Ultra Rivalry-presentatiethema toe; de onderliggende Build-423 homecoming-semantiek telde nog iedere Zone-Soldaat-TP als thuiskomst.",
  after: "Build 425 maakt Zone-Soldaten herbruikbare zonecapaciteit en telt alleen bewezen winstgevende terugkeer uit een andere zone als Winst thuisgekomen.",
  technicalDetails: [
    "Same-zone confirmed TP: OPEN → AVAILABLE, geen homecoming.",
    "Outside-origin confirmed TP: OPEN → DORMANT + TP_WIN_OUTSIDE_ORIGIN_ZONE.",
    "Event-id gebruikt stabiele trade-identiteit voor idempotentie; verwerking van dezelfde close kan geen dubbele thuiskomst schrijven.",
    "Same-tick re-entry wordt lokaal geblokkeerd; een volgende strategie-evaluatie is vereist.",
    "Geen wijziging aan TP-doel, DCA-regels, leverage, exchange close guard, ownership exclusivity, Sniper, wallet/auth of Portfolio TP.",
  ],
