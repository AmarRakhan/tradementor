...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Portfolio Koers gebruikt voor de actuele displaywaarde exact dezelfde zichtbare Aster-equity als Portfolio Snapshot.",
    "De persistente chart-backend blijft historische candles, zones en markers leveren en is alleen fallback wanneer nog geen zichtbare Snapshot-equity beschikbaar is.",
  ],
  problems: [
    "Build 393 kon bovenaan bijvoorbeeld US$ 98,38 tonen terwijl Portfolio Snapshot op hetzelfde scherm US$ 97,47 toonde.",
    "Een later binnenkomende portfolio-chart API-response kon de reeds bevestigde zichtbare Snapshot-equity in de chart overschrijven.",
  ],
  causes: [
    "PortfolioKoersChart schreef normalized.currentEquity uit zijn eigen backend-call opnieuw naar liveEquity nadat liveEquityText uit Portfolio Snapshot al was verwerkt.",
    "Bij de eerste render kon de zichtbare equity bovendien arriveren voordat de candlestick-serie bestond, zodat de eerste candle nog op de backend-close bleef staan.",
  ],
  fixes: [
    "Backend currentEquity mag liveEquity niet meer overschrijven zodra de Portfolio Snapshot-waarde beschikbaar is.",
    "Bij elke chartopbouw wordt de laatst zichtbare Snapshot-equity opnieuw in de actuele candle gemerged, zodat header, candle-close en Portfolio Snapshot gelijk lopen.",
    "Een regressietest bewaakt expliciet dat de backend-waarde de zichtbare Snapshot-equity niet opnieuw kan overnemen.",
  ],
  now: [
    "De actuele Portfolio Koers-waarde en Portfolio Snapshot-portfoliowaarde zijn op hetzelfde scherm één bron van waarheid.",
    "Historische intraperiode highs/lows blijven behouden; alleen de actuele close volgt de zichtbare live Snapshot-equity.",
  ],
  before: "De chart kon na zijn eigen API-refresh tijdelijk een andere actuele equity tonen dan Portfolio Snapshot.",
  after: "Portfolio Koers gebruikt dezelfde actuele equity als Portfolio Snapshot en gebruikt de chart-backend alleen voor historie, zones, markers en fallback.",
  technicalDetails: [
    "Frontend-only synchronisatiefix in web/components/portfolio-koers-chart.tsx plus regressiecontract.",
    "Geen trading-, DCA-, hedge-, TP-, leverage-, order- of backend-executionlogica gewijzigd.",
  ],
