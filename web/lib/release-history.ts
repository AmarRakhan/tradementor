...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    ...
    "Releasecentrum ondersteunt per blok TESTEN, AKKOORD, LIVE en terugtrekken naar BETA.",
  ],
  problems: [
    "De oude instellingenpagina was functioneel maar organisch gegroeid en daardoor moeilijker te volgen.",
    "Nieuwe functies konden voorheen niet veilig per account en per blok worden getest zonder de stabiele gebruikersroute te raken.",
  ],
  causes: [
    "UI-volgorde volgde historische featurebouw in plaats van de beslisvolgorde van de gebruiker.",
    "Er was nog geen server-side releasekanaal voor accountgebonden strategie-experimenten.",
  ],
  fixes: [
    "Nieuwe configurator wordt lazy geladen achter server-side release-entitlements en heeft een eigen Error Boundary.",
    "STABLE houdt de legacy configurator en legacy trade-logica zolang een feature niet expliciet is gepubliceerd.",
