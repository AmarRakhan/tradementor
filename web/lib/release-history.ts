...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Portfolio Koers heeft nu een aparte lichte live-eventfeed voor bevestigde Strategy-2 entries, DCA's en TP's.",
    "De eventlaag ververst iedere 5 seconden zolang de app zichtbaar is, onafhankelijk van de zwaardere 45-seconden candle/chart-refresh.",
    "Nieuwe confirmed events worden direct op de bestaande candlelaag geprojecteerd zonder de hele chart opnieuw op te bouwen.",
    "Wanneer de normale Aster fill-history later hetzelfde event levert, worden beide bronnen samengevoegd zodat geen dubbele marker ontstaat.",
  ],
  problems: [
    "Aster kon een Market order filled-notificatie tonen terwijl Portfolio Koers op 1m nog geen overeenkomstige marker liet zien.",
    "De chart gebruikte recentTradeActivity uit de closed-trades cache, terwijl die fill-history tot 120 seconden gecachet mocht blijven.",
    "De 1m-knop wijzigde daardoor wel de candle-bucketing maar maakte de eventbron zelf niet realtime.",
  ],
  causes: [
    "Portfolio Koers las bevestigde trade-events alleen indirect via de zwaardere Aster fill-history cache.",
    "De volledige chartpayload werd slechts elke 45 seconden vernieuwd en markerwijzigingen waren aan dezelfde chart-rebuild gekoppeld.",
  ],
  fixes: [
    "Nieuwe read-only /portfolio-chart/events route leest uitsluitend recente, reeds bevestigde Strategy-2 audit-events uit Firestore en doet nul extra exchange-API-calls.",
    "De webapp pollt alleen deze lichte markerfeed om de 5 seconden wanneer de pagina zichtbaar is.",
    "Een marker ref laat nieuwe events in de bestaande chart verschijnen zonder chart teardown/recreate.",
    "Live auditmarkers en duurzame fillmarkers worden per timeframe/kind/side gededupliceerd; fill-history blijft de rijkere bron zodra die beschikbaar is.",
  ],
  now: [
    "Een bevestigde bot-entry, DCA of TP hoort binnen enkele seconden als marker op Portfolio Koers te verschijnen.",
    "De blauwe Portfolio Koers-lijn blijft totale portfolio-equity tonen; een entry hoeft de equity-candle zelf dus niet zichtbaar te laten springen.",
    "De bestaande 120s fill-history cache blijft bestaan om Aster rate limits te beschermen, maar blokkeert de recente markerweergave niet meer.",
    "Trading-, DCA-, TP-, leverage-, ownership- en Zone-Soldatenlogica zijn niet gewijzigd.",
  ],
  before: "Build 425 had correcte Zone-Soldatenlogica, maar Portfolio Koers kon recente fills nog pas zien nadat de history-cache was bijgewerkt.",
  after: "Build 426 scheidt de snelle confirmed-eventlaag van de zware fill-history en toont recente trade-events vrijwel direct.",
  technicalDetails: [
    "Live marker cadence: 5 seconden wanneer document.visibilityState === visible.",
    "Backend live-eventroute gebruikt alleen Strategy-2 audit evidence; geen AsterV3Client in deze route.",
    "Normale Portfolio Koers candles en account snapshot houden hun bestaande veilige refresh- en persistencegedrag.",
    "Marker merge voorkomt dubbele entry/TP-markers wanneer audit- en fillbron dezelfde timeframe-bucket beschrijven.",
  ],
