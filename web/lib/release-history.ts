...
const HISTORICAL_RELEASES: ReleaseHistoryEntry[] = [
  ...
  newItems: [
    "Het owner-only Command Center toont nu bevestigde soldier-openingen over 15m, 1u, 4u en 24u met LONG/SHORT afzonderlijk.",
    "De drie meest recente bevestigde soldier-openingen worden newest-first getoond met tijd, side, count en origin zone waar beschikbaar.",
    "Soldier-activiteit wordt opgebouwd uit zone-owned managed positions die pas na een bevestigde fill ontstaan; DCA-count, gewenste/pending soldiers en herstelde legacyposities maken geen nieuwe soldier-open-event.",
    "De activiteitshistorie wordt client-side 25 uur bewaard zodat een later gesloten soldier niet direct uit de recente activiteit verdwijnt.",
    "Portfolio Koers rendert nu alle events waarvan de eigen candle binnen de actuele visible logical range valt.",
    "De normale maxFull:3 / maxCompact:2 selectie is verwijderd; meerdere events op dezelfde candle blijven lokaal gestapeld en aan die candle gekoppeld.",
  ],
  problems: [
    "De gebruiker zag wel hoeveel soldiers nu actief waren, maar niet hoeveel er de laatste 15 minuten, uur, vier uur of dag werkelijk zijn bijgekomen.",
    "Horizontaal scrollen kon een andere globale top-3 markerselectie tonen terwijl de bijbehorende candles nog zichtbaar waren.",
  ],
  causes: [
    "Het Command Center had alleen actuele state, geen historisch venster over bevestigde soldier-openingen.",
    "De marker-layout prioriteerde globaal en clusterde overflow over de viewport in plaats van alle zichtbare candle-events te behouden.",
  ],
  fixes: [
    "De bestaande 45-seconden advisor/accountrefresh registreert bevestigde zone-soldier cycleStartedAtMs-events zonder een nieuwe pollingloop.",
    "Activiteit wordt per UID lokaal gededupliceerd op soldier/cycle-tijd en maximaal 25 uur bewaard.",
    "De chart filtert marker-events eerst op Lightweight Charts visibleLogicalRange en layout daarna alle zichtbare events.",
    "Collision handling gebruikt compactere labels, outward/horizontale offsets en een deterministische last-resort plaatsing; events worden bij normale dichtheid niet verborgen.",
    "Een hoge safety-cap van 160 beschermt alleen tegen corrupte/extreme eventvolumes en is geen normale presentatielimiet.",
  ],
  now: [
    "Owner-account ziet direct 15m/1u/4u/24u soldieractiviteit en recente toevoegingen.",
    "Actieve soldiers blijven een huidige-state metric; soldieractiviteit is expliciet historisch en staat daar los van.",
    "Scrollen verwijdert een marker alleen wanneer zijn candle buiten de viewport valt; er is geen globale top-3 rotatie meer.",
    "Geen algemene rollout: niet-owner accounts behouden de bestaande productie-Strategiestatus.",
  ],
  before: "Build 421 had het owner-only Command Center maar geen soldatenactiviteit en de chart gebruikte nog een globale marker-densitycap.",
  after: "Build 422 voegt owner-only soldier activity windows toe en maakt chart-eventrendering viewport-aware zonder normale top-3 limiet.",
  technicalDetails: [
    "Functionele screenshotreferentie: file_0000000032f081f580ba9f1e8f546c74.",
    "Command Center-referentie: file_00000000d9b0820e8eacdecb418c95aa.",
    "Activity seed gebruikt uitsluitend multiBbPositions met soldierRole ZONE_BASE/EXPOSURE_BALANCER en bevestigde cycleStartedAtMs; geen orderbeslissingen worden toegevoegd.",
    "Geen nieuwe netwerkloop: bestaande advisor refresh blijft 45 seconden.",
