...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  title: "Live Portfolio Koers boven Portfolio Snapshot",
  newItems: [
    "Aster toont boven de bestaande Portfolio Snapshot een compacte live Portfolio Koers met echte account-equity candlesticks.",
    "De chart ondersteunt 1m, 5m, 15m, 1u, 4u en 24u, Bollinger Bands en marktstructuur-gebaseerde support/resistance-zones.",
    "Entry- en winstsluitingen worden compact op de relevante candles gemarkeerd; meerdere winstsluitingen worden samengevat met kleine candle-dots.",
  ],
  problems: [
    "De bestaande Aster-weergave liet de totale portfoliowaarde niet als professionele candlestick-chart zien.",
    "Eerdere concepten gebruikten vaste of illustratieve zone-afstanden, terwijl prijszones juist uit de portfolio-marktstructuur moeten volgen.",
  ],
  causes: [
    "Portfolio-equity werd wel als snapshots gebruikt, maar nog niet duurzaam als OHLC-serie met cashflowcorrectie en structurele zone-analyse opgeslagen.",
  ],
  fixes: [
    "Nieuwe server-side equity-history bewaart betrouwbare Aster totalMarginBalance-observaties en aggregeert die zonder interpolatie naar OHLC-candles.",
    "TRANSFER, WELCOME_BONUS en INSURANCE_CLEAR worden uit de performance-serie geneutraliseerd wanneer de cashflowhistorie compleet aantoonbaar is.",
    "De zone-engine gebruikt bevestigde swing highs/lows, ATR-gebaseerde clustering en support/resistance-structuur; er bestaat geen vaste procent-grid.",
    "De zone-engine draait uitsluitend read-only/shadow en verstuurt nul orders.",
    "De bestaande Portfolio Snapshot, DCA, TP, Portfolio TP, leverage, slot filling, Sniper en walletkoppelingen blijven functioneel ongewijzigd.",
  ],
  now: [
    "De gebruiker ziet direct hoe de eigen Aster-portfoliowaarde beweegt en in welke structurele zone deze staat.",
    "15m is standaard geselecteerd, met compacte zoom en pinch/pan/price-axis scaling.",
    "Dubbel-tap/dubbelklik opent de chart fullscreen; de architectuur is voorbereid op de latere uitgebreide 3D-flip detailzijde.",
  ],
  before: "Portfolio Snapshot toonde actuele kerncijfers maar geen eigen live equity-candlestick-chart met structurele zones.",
  after: "Portfolio Koers staat compact boven Portfolio Snapshot en visualiseert uitsluitend echte accountdata, zonder tradinggedrag te wijzigen.",
  technicalDetails: [
    "Nieuwe frontendcomponent: web/components/aster-portfolio-equity-chart.tsx met lightweight-charts.",
    "Nieuwe backendanalyse: cloud_api/aster_portfolio_equity_chart.py plus read-only chart/backtest endpoints.",
    "Officiële serverhistorie begint bij het eerste betrouwbare opgeslagen datapunt; ontbrekende candles worden niet verzonnen.",
    "Primaire visuele referentie: file_00000000c7ec820ab9697735bb027326.",
  ],
...
const HISTORICAL_RELEASES: ReleaseHistoryEntry[] = [
  {
    id: "v46-build-392-independent-side-slots",
    version: "46",
    build: "392",
