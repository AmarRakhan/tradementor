...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Maximaal vijf volledige eventlabels tegelijk; overige events worden compact geclusterd zonder onderliggende eventdata te verliezen.",
    "Render-only collision detection voorkomt stapeling, prijsas-overlap en de eventmuur uit Build 397.",
    "Prijszones gebruiken nu uitsluitend echte price coordinates en krijgen duidelijkere rood-, amber-, groen- en blauwtinten volgens de referentiefoto.",
    "De chart toont expliciet de actuele context, bijvoorbeeld 15m candles · 15m zones · BB 20,2.",
    "Grotere timeframes krijgen aangepaste tijdaslabels en visuele candle-spacing zodat 1u, 4u en 24u duidelijk anders lezen dan 1m/5m.",
  ],
  problems: [
    "Bij veel handmatige acties domineerden Entry-, L- en TP-boxes de candles en stapelden labels vooral links over elkaar.",
    "De horizontale marktcontext uit de referentiefoto was in Build 397 te zwak zichtbaar.",
    "De gebruiker kon onvoldoende zien welk timeframe de candles en zones vertegenwoordigen.",
  ],
  causes: [
    "Build 397 renderde ieder bevestigde event als volledige overlaybox zonder globale collision- of densitylimiet.",
    "De chartachtergrond bevatte decoratieve vaste kleurgradaties terwijl de echte dynamische zones te subtiel waren.",
  ],
  fixes: [
    "Een pure marker-layouthelper selecteert maximaal vijf prominente labels op prioriteit en recency, probeert beperkte verschuivingen en clustert de rest.",
    "Alle eventmarkers blijven afkomstig van bestaande bevestigde backenddata; geen synthetische events of bedragen toegevoegd.",
    "Statische zonekleurblokken zijn verwijderd; alleen zonebanden die via priceToCoordinate aan echte zoneprijzen zijn gekoppeld worden weergegeven.",
    "Markerboxes zijn kleiner, minder glowy en visueel ondergeschikt aan candles en Bollinger.",
  ],
  now: [
    "Candles zijn weer het primaire visuele element en drukke handmatige handelsperiodes blijven leesbaar.",
    "Crosshair/tap behoudt toegang tot individuele eventdetails terwijl de standaardweergave rustig blijft.",
    "Portfolio Koers current equity blijft exact de zichtbare Portfolio Snapshot-equity volgen.",
  ],
  before: "Meer dan tien prominente labels konden tegelijk over candles en elkaar heen staan, met nauwelijks zichtbare zonecontext.",
  after: "Maximaal vijf prominente labels, compacte clusters voor de rest en duidelijke prijsgebonden achtergrondzones volgens de goedgekeurde referentie.",
  technicalDetails: [
    "Gewijzigde functionele scope: portfolio-koers-chart.tsx, portfolio-koers-chart.css en pure portfolio-koers-marker-layout.mjs plus tests.",
    "Build-398 scopeguard faalt wanneer auth-provider, auth-gate, layout, PWA-registration, service worker of manifest in deze release worden gewijzigd.",
    "Geen backend, API, accountSnapshot, realtime, polling, WebSocket/SSE, order-, DCA-, hedge-, TP-, leverage-, Strategy-2- of Sniperlogica gewijzigd.",
  ],
