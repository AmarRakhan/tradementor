...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  title: "Portfolio TP 2.1 - werkelijke sluitwaarde wordt nieuwe cycle start",
  newItems: [
    "De nieuwe Portfolio TP-cycle gebruikt na een volledige exit altijd de werkelijk door Aster bevestigde post-close equity als nieuwe Cycle start.",
    "De duurzame multiBbCycle is nu expliciet onderdeel van de publieke Strategy-2 status en is in de UI de bron van waarheid boven oudere reportsnapshots.",
    "Wanneer Aster na het sluiten tijdelijk geen geldige equity teruggeeft, wacht de cycle fail-closed op betrouwbare equity in plaats van een nieuwe baseline te verzinnen.",
  ],
  problems: [
    "Na een cyclewissel kon de webinterface nog een oudere Portfolio-report snapshot tonen, waardoor Cycle start en Target achterliepen op de duurzame serverstate.",
    "De flat-confirmatie had nog geen aparte fail-closed guard voor het uitzonderlijke geval waarin de post-close account-equity tijdelijk ontbrak.",
  ],
  causes: [
    "De publieke Strategy-2 status gaf multiBbReport wel door, maar de autoritatieve multiBbCycle niet; frontendcomponenten konden daardoor alleen op een mogelijk oudere reportsnapshot terugvallen.",
    "Na exchange-flat werd endEquity direct gebruikt zonder expliciete validatie dat de post-close accountwaarde groter dan nul en betrouwbaar beschikbaar was.",
  ],
  fixes: [
    "multiBbCycle wordt rechtstreeks gepubliceerd; Portfolio Cyclus en Strategy Maker geven deze duurzame state voorrang op multiBbReport.portfolioCycle.",
    "Bij ontbrekende post-close equity blijft de runtime in FLAT_CONFIRMING, opent niets nieuws en probeert de werkelijke sluitwaarde op de volgende tick opnieuw te lezen.",
    "Regressietests dekken zowel de cycle-rollover als een tijdelijk ontbrekende equity en de gemelde 102,95 → 103,50 → 104,0175-situatie.",
  ],
  now: [
    "Voorbeeld: Cycle start $102,95 met +0,5% heeft target $103,47; sluit de portefeuille werkelijk op $103,50, dan start de volgende cycle op $103,50 met target $104,0175.",
    "Huidige waarde blijft een eenmalige snapshot bij opslaan en beweegt niet continu mee tijdens een lopende cycle.",
    "Geen extra tradingorder is toegevoegd; de nieuwe guard kan een herstart alleen uitstellen totdat betrouwbare post-close equity beschikbaar is.",
  ],
  before: "De backend kon correct doorrollen, maar de UI kon een oudere reportsnapshot blijven tonen en een ontbrekende post-close equity had geen expliciete herstartblokkade.",
  after: "Duurzame cycle-state is zichtbaar end-to-end en iedere nieuwe cycle start uitsluitend vanaf bevestigde werkelijke sluit-equity.",
  technicalDetails: [
    "Autoritatieve velden: multiBbCycle.cycleStartEquity, baseEquity, targetEquity en cycleStatus.",
    "Post-close equity <= 0 houdt de transactie in FLAT_CONFIRMING; er wordt geen zero- of theoretische baseline opgeslagen.",
    "CURRENT_VALUE wordt maximaal eenmaal per configVersion vastgezet; automatische rollover normaliseert de volgende basis naar CYCLE_START.",
  ],
  confidence: "confirmed",
};
const HISTORICAL_RELEASES: ReleaseHistoryEntry[] = [
  {
    id: "v46-build-439-full-history-liquidation-returns",
    version: "46",
    build: "439",
    releasedAt: "2026-09-26",
    title: "Dagrendement 2.3 - volledige historie + liquidaties",
    newItems: [
      "Gemiddeld per dag reconstrueert alle betrouwbare voltooide dagen uit de opgeslagen account-equityhistorie; de vaste 14-dagenlimiet is verwijderd.",
      "Liquidatie/ADL-gerelateerde INSURANCE_CLEAR blijft onderdeel van rendement en wordt niet meer als externe storting/opname weggefilterd.",
      "De dagelijkse historie blijft vanaf de eerste betrouwbare opgeslagen equity-dag bewaard in plaats van na 120 dagen te worden afgekapt.",
    ],
    problems: [
      "Build 438 kon oudere betrouwbare dagen buiten de laatste 14 dagen niet meenemen.",
      "INSURANCE_CLEAR stond ten onrechte in de externe-cashflowclassificatie en kon daardoor een verliescomponent uit het rendement neutraliseren.",
    ],
    causes: [
      "De historische reconstructie had een expliciete max_days=14 en las slechts 400 1u-candles.",
      "De cashflowclassificatie behandelde een trading/liquidatie-gerelateerd Aster incomeType als niet-performance kapitaalstroom.",
    ],
    fixes: [
      "DailyGrowth schema v4 forceert een herberekening met de gecorrigeerde classificatie.",
      "De reconstructie leest alle beschikbare 1u account-equitycandles en neemt iedere complete, betrouwbaar gedekte Nederlandse kalenderdag mee.",
      "TRANSFER/deposit/withdrawal-achtige kapitaalbewegingen blijven rendement-neutraal; realized PnL, funding, commissies en INSURANCE_CLEAR blijven zichtbaar in performance.",
    ],
    now: [
      "Gemiddeld per dag gebruikt de volledige betrouwbare accountgeschiedenis die de app als equity-candles heeft opgeslagen.",
      "Liquidaties/ADL en overige tradingkosten tellen mee in rendement; echte externe kapitaalstromen niet.",
      "Geen wijziging aan trading-, DCA-, TP/SL-, Auto-Hedge- of Zone-Soldaten executionlogica.",
    ],
    before: "Build 438 reconstrueerde maximaal 14 dagen en neutraliseerde INSURANCE_CLEAR als cashflow.",
    after: "Build 439 reconstrueert alle betrouwbare opgeslagen dagen en laat liquidatie/tradingeffecten volledig in rendement staan.",
    technicalDetails: [
      "DailyGrowth schemaVersion 4.",
      "Historische bron: alle beschikbare persisted 1u Aster account-equity candles, alleen complete lokale dagen.",
      "Geen 14-dagen- of 120-dagenretentiecap in de dagelijkse performancehistorie.",
      "Aster income-ledger blijft per dag fail-closed bij een onvolledige pagina.",
    ],
    confidence: "confirmed",
  },

  {
    id: "v46-build-438-daily-return-history",
    version: "46",
    build: "438",
    releasedAt: "2026-09-26",
...

  {
    ...
    technicalDetails: [
      ...
      "Release-contract pulse bevat app-versie en releasehistorie in dezelfde canonieke push.",
    ],
    confidence: "confirmed",
  },
  {
  ...
  },
  {
    ...
    title: "Portfolio Koers 2.0 · cashflow-gecorrigeerde performance",
    newItems: ["Performance/Accountwaarde-weergave, cashflowmarkers en live Zone-Soldaten status toegevoegd."],
    problems: ["Dagperformance kon nog een stale vorige-dagreferentie gebruiken."],
    causes: ["De oorspronkelijke dailyGrowth v1-referentie werd bij datumwissels doorgerold."],
    fixes: ["Cashflowbreakdown en TWR-audit toegevoegd; Build 433 vervangt de dagreferentielogica."],
    now: ["Opgevolgd door Build 433 voor betrouwbare dagstart en gemiddelde-statistiek."],
    confidence: "confirmed",
  },
  {
    id: "v46-build-431-auto-hedge-2",
    version: "46",
    build: "431",
    releasedAt: "2026-09-25",
    title: "Auto Hedge 2.0 · exact 1:1 met recovery",
    newItems: [
      "Auto Hedge beheert een getriggerd pair stateful en bewaakt exact gelijke LONG/SHORT coin quantity.",
      "HEDGE_LOCK beschermt Auto Hedge quantity tegen normale automatische sluitpaden.",
      "RECOVERY en een expliciete Opnieuw hedgen-schakelaar beheren de lifecycle na sluiten van de protected leg.",
    ],
    problems: ["Build 430 kende nog geen volledige persistente exact-1:1 pair lifecycle."],
    causes: ["De eerste shadowimplementatie was leg-gebaseerd en kende nog geen volledige allocation-reservering."],
    fixes: [
      "Exact 1:1 reconciliation, generationId/idempotency, recovery en centrale close-guards toegevoegd.",
      "Production Auto Hedge execution bleef expliciet gated.",
    ],
    now: ["Build 432 behoudt deze Auto Hedge-logica en vereenvoudigt alleen de Snapshot-tegel."],
    before: "Build 430 was de eerste owner-only Auto Hedge shadowtest.",
    after: "Build 431 maakte de volledige lifecycle beschikbaar zonder de execution gate automatisch live te zetten.",
    technicalDetails: ["Primaire UI-reference: file_00000000ecd08246bd1b15532fb478d6."],
    confidence: "confirmed",
  },


  {
    id: "v46-build-430-position-loss-auto-hedge",
    version: "46",
    build: "430",
    releasedAt: "2026-09-25",
    title: "Auto Hedge · eerste owner-only shadowtest",
    newItems: [
      "Nieuwe per-positie Auto Hedge-tegel en read-only reconciliation tegen echte Aster position_risk-data.",
      "Dollarverlies per individuele leg bepaalt de eerste hedge-trigger; coin quantity is de basis.",
    ],
    problems: ["De eerste versie beheerde nog geen volledige pair lifecycle of overdekking."],
    causes: ["Build 430 was bewust een shadow/testfase vóór live orderuitvoering."],
    fixes: [
      "Owner-only worker, persisted threshold, pending-order deduction en auditbasis toegevoegd.",
      "Production execution gate expliciet false gehouden.",
    ],
    now: ["Build 431 vervangt deze eerste lifecycle door exact 1:1 hedge-lock, recovery en rehedge."],
    before: "Build 429 herstelde de mobiele Friends-portal.",
    after: "Build 430 maakte een veilige account-shadowtest mogelijk.",
    technicalDetails: [
      "Build-430 productiecommit: 92b468da265546b76c7b9608560b3968960a674f.",
      "Geen live Auto Hedge-orders in deze release.",
    ],
    confidence: "confirmed",
  },

  {
    id: "v46-build-429-friends-mobile-hotfix",
    version: "46",
    build: "429",
    releasedAt: "2026-09-25",
    title: "Friends · tab opent nu direct",
    newItems: ["FRIENDS vervangt nu direct de onderliggende Aster-content zodra de Friends-route actief wordt."],
    problems: ["De FRIENDS-knop werd visueel actief, maar op mobiel bleef de Aster-pagina zichtbaar."],
    causes: ["De Friends-route miste de dedicated globale bridge-CSS van de bestaande hoofdviews."],
    fixes: ["Dedicated friends-bridge.css, vaste portalclass en mobiele content-isolatie toegevoegd."],
    now: ["Tik op FRIENDS opent de Friends-pagina direct op dezelfde plek waar Aster stond."],
    before: "Build 428 introduceerde Friends.",
    after: "Build 429 corrigeerde uitsluitend de Friends presentatielaag.",
    technicalDetails: ["Geen wijziging aan Aster/Sniper trading, DCA, TP/SL, ownership of orders."],
    confidence: "confirmed",
  },

  {
    ...
    build: "428",
    releasedAt: "2026-09-25",
    title: "Friends · leer van rendement én risico",
    newItems: [
      "Nieuw hoofdtabblad FRIENDS met ranking, traderprofielen, instellingen, strategieën en Vergelijk & leer.",
      "Genormaliseerd rendement wordt samen met server-side risicoscore weergegeven.",
    ],
    problems: ["De app had nog geen communitylaag om aanpak, rendement en risico te vergelijken."],
    causes: ["De bestaande percentage- en strategie-evidence had nog geen Friends-presentatielaag."],
    fixes: [
      "Privacy-safe Friends API en mobiele Friends UI toegevoegd.",
      "Absolute equity, balances, walletgegevens, notional en exacte dollar-PnL blijven privé.",
    ],
    now: ["Friends-data en risicoanalyse zijn beschikbaar; Build 429 corrigeert de mobiele portalweergave."],
    before: "Build 427 herstelde de Continuity/Bybit betaalreserve.",
    after: "Build 428 introduceerde Friends.",
    technicalDetails: [
      "Backend revision na release: tradementor-api-src-f5182838-891054.",
      "Referentiebeelden A-D zijn in de Friends bron vastgelegd.",
    ],
    confidence: "confirmed",
  },
...

  {
    ...
    build: "426",
    releasedAt: "2026-09-25",
    title: "Portfolio Koers · trade-events vrijwel direct zichtbaar",
    newItems: [
      "Lichte live-eventfeed voor bevestigde Strategy-2 entries, DCA's en TP's.",
      "Nieuwe confirmed events worden zonder volledige chart-rebuild op de bestaande candlelaag geprojecteerd.",
    ],
    problems: ["Aster kon een filled-notificatie tonen voordat Portfolio Koers dezelfde marker liet zien."],
    causes: ["Trade-events kwamen alleen via de zwaardere fill-history cache binnen."],
    fixes: [
      "Een aparte read-only eventroute leest recente bevestigde Strategy-2 audit-events zonder extra exchange polling.",
      "Audit- en fillmarkers worden gededupliceerd wanneer beide bronnen hetzelfde event beschrijven.",
    ],
    now: ["Bevestigde entries, DCA's en TP's verschijnen doorgaans binnen enkele seconden op Portfolio Koers."],
    before: "Build 425 had correcte Zone-Soldatenlogica maar nog geen snelle markerfeed.",
    after: "Build 426 scheidt de snelle confirmed-eventlaag van de zware fill-history.",
    technicalDetails: ["Live marker cadence 5 seconden wanneer de app zichtbaar is; tradinglogica ongewijzigd."],
    confidence: "confirmed",
  },

  {
    id: "v46-build-425-zone-soldiers-reusable-homecoming",
    version: "46",
    build: "425",
    releasedAt: "2026-09-24",
    title: "Zone-Soldaten · herbruikbare missies + echte thuiskomst",
    newItems: [
      "Zone-Soldaten zijn blijvende capaciteit van hun eigen price zone en kunnen binnen die actieve zone meerdere winstmissies uitvoeren.",
      "Same-zone TP maakt dezelfde ZONE_BASE-soldaat opnieuw AVAILABLE; outside-origin TP maakt hem DORMANT en kan één echte homecoming registreren.",
    ],
    problems: ["Build 423 telde iedere winstgevende Zone-Soldaat-TP nog als homecoming."],
    causes: ["Homecoming-events misten de aantoonbare currentZoneAtClose-semantiek."],
    fixes: [
      "Alleen TP_WIN_OUTSIDE_ORIGIN_ZONE met verschillende originZone en currentZoneAtClose telt nog als echte thuiskomst.",
      "Same-tick re-entry van een net vrijgekomen soldaat is geblokkeerd.",
    ],
    now: [
      "Actieve zones kunnen dezelfde soldaten opnieuw inzetten na winst; oude-zone posities blijven onafhankelijk beheerd.",
      "Exposure balancing blijft PRIORITY_ONLY zonder extra capaciteit.",
    ],
    before: "Build 424 voegde uitsluitend het Ultra Rivalry-thema toe.",
    after: "Build 425 maakt de zonecapaciteit herbruikbaar en de homecoming-teller semantisch correct.",
    technicalDetails: ["zoneSoldierState schemaVersion 3; backend en V46 web exact-source uitgerold."],
    confidence: "confirmed",
  },

  {
    id: "v46-build-424-ultra-rivalry",
    version: "46",
    build: "424",
    releasedAt: "2026-09-24",
    title: "ASTER · Ultra Rivalry presentatiethema",
    newItems: [
      "WALLET → Thema bevat Ultra Rivalry als extra opgeslagen ASTER-skin.",
      "De skin verandert uitsluitend de presentatielaag; bestaande data, handlers en tradinggedrag blijven gelijk.",
    ],
    problems: ["ASTER had nog geen uitgesproken battle-thema binnen het bestaande skin-systeem."],
    causes: ["Het bestaande app-skin systeem had nog geen ASTER-only Ultra Rivalry variant."],
    fixes: ["Ultra Rivalry is toegevoegd als strikt gescopeerde presentation layer zonder nieuwe state- of tradinglogica."],
    now: ["Gebruikers kunnen Ultra Rivalry kiezen terwijl alle bestaande ASTER-functionaliteit hetzelfde blijft werken."],
    before: "Build 423 corrigeerde de vaste zoneformatie.",
    after: "Build 424 voegde uitsluitend het optionele ASTER-thema toe.",
    technicalDetails: ["Geen backend-, trading-engine-, order-, scheduler- of exchangebestand gewijzigd voor deze theme-release."],
    confidence: "confirmed",
  },

  {
  id: "v46-build-423-zone-soldiers-fixed-formation",
  version: "46",
  build: "423",
  releasedAt: "2026-09-24",
  title: "Zone-Soldaten · vaste formatie + winst thuisgekomen",
  newItems: [
    "Het owner-only Strategiestatus Command Center is herbouwd naar de goedgekeurde referentie file_000000009e0081f4b88f4b415de68c71.",
    "De actieve formatie toont nu Thuis/Beschikbaar, In het veld, Oude zones nog buiten, Winst thuisgekomen, Entry-prioriteit en Volgende mogelijke instroom.",
    "Exposure-balancing is PRIORITY_ONLY: de balancer bepaalt uitsluitend welke bestaande ZONE_BASE-zijde prioriteit krijgt.",
    "Bevestigde winstgevende TP-sluitingen van zone-owned soldiers worden persistent als homecoming geregistreerd.",
  ],
  problems: [
    "De vorige status kon bijvoorbeeld +11 LONG tonen terwijl de actieve zone slechts 3 LONG-soldaten in zijn vaste formatie had.",
    "De exposure-balancer kon tijdelijke EXPOSURE_BALANCER-soldaten bovenop de vaste zoneformatie materialiseren.",
    "De gebruiker zag vooral soldaten vertrekken en niet hoeveel zone-soldaten na winst terugkeerden.",
  ],
  causes: [
    "De balancer gebruikte desiredCount als extra capaciteit in plaats van alleen als directionele stuurinformatie.",
    "TP-sluitingen hadden auditlogging maar nog geen persistent homecoming-event voor het Command Center.",
  ],
  fixes: [
    "Alle nieuwe zone-entrycapaciteit komt uitsluitend uit geconfigureerde ZONE_BASE-soldaten.",
    "Balancer-hysterese stuurt alleen LONG/SHORT entry-prioriteit; desiredCount is hard nul en balancerFree is nul.",
    "Als de prioriteitszijde vol zit wordt de tegenovergestelde zijde niet automatisch gevuld om de bestaande exposure-onbalans verder te vergroten.",
    "Niet-open historische balancer-capaciteit wordt bij normalisatie verwijderd; reeds open historische balancerposities blijven veilig beheerd tot hun normale sluiting.",
    "Na exchange-bevestigde TP-flat wordt vóór het verwijderen van ownership-state een idempotent TP_WIN-homecoming opgeslagen.",
  ],
  now: [
    "Een zone met 3 LONG + 3 SHORT heeft exact zes nieuwe-entry soldiers; de balancer kan daar geen extra soldiers bovenop zetten.",
    "Netto exposure bepaalt alleen de entry-prioriteit binnen de vrije vaste soldaten.",
    "Oude-zone posities blijven buiten en beheerd; een zonewissel sluit niets geforceerd.",
    "Alleen bevestigde winst-TP's verhogen Winst thuisgekomen; verlies wordt niet als thuiskomst geboekt.",
  ],
  before: "Build 422 kon tijdelijke balancer-soldaten bovenop de basisformatie laten ontstaan en toonde nog geen winst-homecomings.",
  after: "Build 423 maakt de zoneformatie hard, balanceert uitsluitend via entry-prioriteit en toont winstgevende thuiskomsten.",
  technicalDetails: [
    "Visuele referentie: file_000000009e0081f4b88f4b415de68c71.",
    "Plaatsingsreferentie: file_0000000010e48243aa4fa2fe0c6e6c20.",
    "zoneSoldierState schemaVersion is verhoogd naar 2; bestaande OPEN EXPOSURE_BALANCER-posities blijven backward-compatible beheerd.",
    "Geen wijziging aan DCA-regel, TP-doel, leverage guards, exchange close guard, auth of PWA.",
  ],
  confidence: "confirmed",
},
  {
    ...
    newItems: [
      "Owner-only soldier activity windows en viewport-aware zichtbare chart-events.",
    ],
    problems: [
      "Exposure-balancing kon nog extra tijdelijke capaciteit bovenop de vaste zoneformatie materialiseren.",
    ],
    causes: [
      "Build 422 veranderde de bestaande exposure-balancer-semantiek niet.",
    ],
    fixes: [
      "Build 423 vervangt extra balancer-capaciteit door priority-only routing.",
    ],
    now: [
      "De activityhistorie uit Build 422 blijft diagnostisch beschikbaar.",
    ],
    confidence: "confirmed",
  },
  {
    ...
    build: "421",
    releasedAt: "2026-09-24",
    title: "Account-only Strategy Status Command Center test",
    newItems: [
      "Hard owner-only Command Center met echte Snapshot LONG/SHORT/Available en read-only runway-schattingen.",
      "Alle overige accounts houden de bestaande Strategy Cockpit.",
    ],
    problems: [
      "De gebruiker kon nog niet direct zien hoeveel bevestigde soldiers recent waren toegevoegd.",
      "Portfolio Koers beperkte de standaard eventlaag nog tot maximaal drie hoofdlabels en twee clusters.",
    ],
    causes: [
      "Build 421 richtte zich op huidige strategie-state en reserve/runway, niet op tijdvensters van soldier-openingen.",
      "De chart droeg nog de oudere globale density-cap uit Build 399/400.",
    ],
    fixes: [
      "Owner-only Command Center en één zichtbare waarheid voor actieve LONG/SHORT/Available ingevoerd.",
    ],
    now: [
      "Build 422 voegt activity windows toe en verwijdert de normale globale top-3 eventlimiet.",
    ],
    confidence: "confirmed",
  },
  {
    id: "v46-build-420-strategy-cockpit",
    version: "46",
    build: "420",
    releasedAt: "2026-09-24",
    title: "Portfolio Koers · heldere zones + strategie-cockpit",
    newItems: [
      "Portfolio Koers houdt chart en async zone-overlays stabiel van elkaar gescheiden.",
      "Zone-Soldatenstatus gebruikt een compacte Strategy Cockpit onder de grafiek.",
      "Exposure-refill-uitleg maakt de optionele versnelling explicieter.",
    ],
    problems: [
      "De compacte cockpit liet nog niet in één oogopslag zien hoeveel Available werkelijk over is, hoeveel soldaten/DCA daarmee nog betaalbaar zijn en of een gewenste balansactie daadwerkelijk uitvoerbaar is.",
      "De zichtbare soldatentelling kon qua betekenis afwijken van de totale actieve LONG/SHORT telling in Portfolio Snapshot.",
    ],
    causes: [
      "De cockpit was primair een zone-/formatie-overzicht en gebruikte verschillende runtime-subsets naast accountbrede Snapshot-tellingen.",
    ],
    fixes: [
      "Chart lifecycle, rustige overlays en compacte strategiepresentatie zijn gestabiliseerd.",
    ],
    now: [
      "Build 421 test alleen voor het hard owner-account een uitgebreider Command Center; overige accounts houden exact deze Build-420 cockpit.",
    ],
    confidence: "confirmed",
  },
  {
    id: "v46-build-419-zone-soldier-safe-defaults",
    version: "46",
    build: "419",
    releasedAt: "2026-09-24",
