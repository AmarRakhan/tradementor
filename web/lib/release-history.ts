...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  title: "Rendement vandaag volgt nu de actuele portfoliosnapshot",
  newItems: [
    "Rendement vandaag wordt opnieuw opgehaald zodra een nieuwe bevestigde Aster-accountsnapshot binnenkomt.",
  ],
  problems: [
    "De portfoliowaarde kon zichtbaar veranderen terwijl Rendement vandaag op een oude waarde, bijvoorbeeld -0,40%, bleef staan.",
  ],
  causes: [
    "De dagelijkse rendementroute werd alleen bij het openen van de Portfolio Growth-component opgehaald en daarna niet gekoppeld aan nieuwe Aster-accountsnapshots.",
    "De compacte Portfolio Snapshot las die oude waarde correct uit de bestaande kaart, waardoor een DOM-sync of vijfsecondencontrole de verouderde bronwaarde niet kon oplossen.",
  ],
  fixes: [
    "Aster-snapshots bewaren nu apart wanneer de laatste echte server/accountrefresh is bevestigd.",
    "Portfolio Growth gebruikt dat bevestigde servermoment als refreshsignaal voor /portfolio-growth/daily.",
    "Realtime mark-price ticks blijven buiten dit refreshsignaal, zodat de zwaardere dagelijkse endpoint niet onnodig honderden keren wordt aangeroepen.",
  ],
  now: [
    "Wanneer PORTFOLIOWAARDE na de normale Aster-accountrefresh verandert, wordt RENDEMENT VANDAAG in dezelfde refreshcyclus opnieuw berekend.",
    "Handmatig vernieuwen en terugkeren naar de app veroorzaken via de bestaande accountrefresh eveneens een nieuwe dagelijkse rendementscontrole.",
  ],
  before: "PORTFOLIOWAARDE werd periodiek vernieuwd, maar RENDEMENT VANDAAG kon vanaf het openen van de pagina urenlang dezelfde oude waarde blijven tonen.",
  after: "Iedere bevestigde Aster-accountsnapshot triggert ook een verse dagelijkse rendementsberekening; de twee cijfers lopen daardoor niet meer op verschillende refreshcycli.",
  technicalDetails: [
