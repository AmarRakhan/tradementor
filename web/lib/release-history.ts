...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "De drie lagere zones zijn niet langer drie varianten van vrijwel hetzelfde groen, maar krijgen duidelijk verschillende donkere groentinten/teal-tinten.",
    "Zone 0 blijft duidelijk blauw; hogere zones lopen zichtbaar via amber/oranje naar rood.",
    "Niet-actieve zonegrenzen zijn neutraal grijs gemaakt zodat ze niet meer als extra groene levels ogen.",
  ],
  problems: [
    "Op de huidige 15m-weergave leken de grenzen rond circa 100 en 80 op losse groene lijnen binnen één grote groene achtergrond.",
    "Daardoor was niet in één oogopslag duidelijk dat het om aparte lagere zones ging.",
  ],
  causes: [
    "Zone -3, -2 en -1 hadden wel verschillende opacity, maar te weinig kleurverschil op een donker OLED-scherm.",
    "De gewone structural boundary kleur mengde visueel met de groene zonefills.",
  ],
  fixes: [
    "Zone -3 is nu diep forest, Zone -2 teal en Zone -1 duidelijk emerald; de tinten en opacity zijn verder uit elkaar gezet.",
    "Zone 0 is sterker blauw, Zone +1 amber, Zone +2 oranje en Zone +3 bordeaux/rood.",
    "Reguliere grenzen gebruiken alleen een subtiele neutrale lijn; uitsluitend VOLGENDE ↑ en VOLGENDE ↓ behouden de duidelijke goud/groene accentkleur.",
    "De bestaande actieve-zone-highlight, next-level labels en soldatenlogica blijven ongewijzigd.",
  ],
  now: [
    "Een grens rond 100 of 80 is alleen nog logisch leesbaar als scheiding tussen twee werkelijk verschillend gekleurde vlakken.",
    "Er zijn geen willekeurige groene horizontale lijnen meer die visueel dezelfde status lijken te hebben als de actieve next-down grens.",
    "Deze wijziging blijft alleen zichtbaar op het BETA-owner account.",
  ],
  before: "Build 408 maakte de chart functioneel tot beslissingskaart, maar de lagere zones waren op telefoon nog te gelijk van kleur.",
  after: "Build 409 verandert uitsluitend de visuele zonehiërarchie; zoneberekening en tradinggedrag blijven gelijk.",
  technicalDetails: [
    "Signed zone classes level-n3/n2/n1/0/p1/p2/p3 hebben nu expliciet uiteenlopende RGBA-paletten.",
    "Regular boundary opacity en kleur zijn neutraal; next-up en next-down blijven functioneel geaccentueerd.",
    "Geen wijzigingen aan backend trading, DCA, TP, orders, closes of stoelactiecontract.",
  ],
