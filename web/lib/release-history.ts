...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Alleen het hard owner/BETA-account ziet onder Portfolio Koers het nieuwe Zone-Soldaten Strategy Status Command Center uit referentie file_00000000d9b0820e8eacdecb418c95aa.",
    "Het Command Center toont expliciet of een gewenste LONG/SHORT-balansactie daadwerkelijk automatisch uitvoerbaar is, of waarom die wacht/geblokkeerd is.",
    "Available, actieve LONGs en actieve SHORTs komen rechtstreeks uit dezelfde live Snapshot-state als Portfolio Snapshot.",
    "De zichtbare totaaltelling soldaten is altijd LONG + SHORT; een afwijkende zone-owned subset wordt niet meer als algemene totaaltelling gepresenteerd.",
    "Nieuwe read-only schattingen tonen hoeveel extra soldaten en gemiddelde DCA-rondes met het actuele Available ongeveer nog betaalbaar zijn.",
    "Actieve zone, volgende/vorige zone, formatie per zone, LONG/SHORT-balans, vrije zonecapaciteit en runway-health staan in één scanbaar dashboard.",
  ],
  problems: [
    "De bestaande Strategy Cockpit maakte onvoldoende duidelijk of '+N LONG/SHORT gewenst' ook werkelijk automatisch uitgevoerd zou worden.",
    "113 zone-owned soldaten versus 115 actieve posities kon als een tel-fout overkomen wanneer de subset niet expliciet benoemd was.",
    "De gebruiker kon niet direct zien hoe lang de strategie met huidig Available nog ongeveer soldaten of DCA-rondes kan dragen.",
  ],
  causes: [
    "De oude cockpit combineerde zone-runtime-subsets met accountbrede positiegegevens zonder één genormaliseerd presentatiemodel.",
    "Available, positieaantallen, sizing en DCA-configuratie werden niet samen naar één read-only runway-viewmodel vertaald.",
  ],
  fixes: [
    "Eén StrategyStatusCommandCenter-viewmodel normaliseert de zichtbare waarden vóór rendering.",
    "De Command Center-totaaltelling gebruikt dezelfde LONG/SHORT-bron als Portfolio Snapshot en berekent totaal = LONG + SHORT.",
    "Betaalbare soldaten worden dynamisch geschat uit actueel Available en de huidige zone-entry sizingmodus/leverage; ontbrekende fee- of marktminimumdata wordt niet verzonnen.",
    "DCA-runway wordt dynamisch geschat uit actueel Available en de opgeslagen DCA-marginconfiguratie.",
    "ActionExecutable vereist strategy AAN, veilige bevestigde zone, voldoende Available en beschikbare zonecapaciteit voordat de UI 'automatisch' claimt.",
    "De nieuwe UI is uitsluitend zichtbaar bij betaOwner === true; releaseChannel alleen is geen toegangsgate.",
  ],
  now: [
    "Account-only test: het owner-account ziet het nieuwe Command Center.",
    "Geen algemene rollout: alle overige accounts blijven de bestaande Build-420 Strategy Cockpit zien.",
    "Er zijn geen order-, DCA-, TP/SL-, zone-detectie-, position-ownership-, exchange-, polling-, auth- of PWA-paden gewijzigd.",
  ],
  before: "Build 420 toont een compacte Strategy Cockpit met zone, formatie, balans en volgende zone.",
  after: "Build 421 vervangt dat blok uitsluitend voor het hard owner-account door een uitgebreider Command Center met echte Snapshot-tellingen, Available en read-only runway-schattingen.",
  technicalDetails: [
    "Primaire visuele referentie: file_00000000d9b0820e8eacdecb418c95aa.",
    "Plaatsingsreferentie: file_00000000f968820e8c1b320d45fb2157.",
    "Account-gate gebruikt de bestaande server-bevestigde betaOwner UID-claim uit AuthProvider; geen generieke BETA-channel gate voor deze nieuwe component.",
    "Portfolio Snapshot geeft equity, Available, LONG en SHORT als props door aan Portfolio Koers zodat beide UI's dezelfde zichtbare waarheid gebruiken.",
    "Scope is beperkt tot webpresentatie, read-only berekeningshelper, tests en release/version metadata.",
  ],
