...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "BETA-prijszones vullen nu de volledige zichtbare grafiekhoogte in plaats van alleen de smalle bevestigde S/R-banden.",
    "Wanneer de actuele portfolio-equity boven of onder de hoogste bevestigde zone komt, worden Zone +1/+2/+3 of Zone -1/-2/-3 veilig doorgetrokken.",
    "De koersinstructie gebruikt dezelfde uitgebreide zone-indeling als de achtergrond, zodat BALANS niet meer kan blijven staan wanneer de koers duidelijk buiten Zone 0 ligt.",
  ],
  problems: [
    "Build 405 kleurde alleen de al bevestigde zonebanden; grote delen van de chart bleven daardoor donker.",
    "De actieve zone gebruikte bij een koers buiten alle bevestigde banden de dichtstbijzijnde bekende zone. Daardoor kon 141,18 nog als Zone 0/BALANS worden behandeld terwijl de bekende zones rond 100-108 lagen.",
  ],
  causes: [
    "portfolioZoneForPrice viel buiten bestaande banden terug op de dichtstbijzijnde bevestigde zone en de overlay gebruikte voor de buitenste regio alleen de eigen zoneband in plaats van de volledige prijsruimte.",
  ],
  fixes: [
    "Voor het BETA-owner account wordt uit bevestigde zonecentra een volledige -3 t/m +3 ladder opgebouwd; ontbrekende buitenzones worden met de bevestigde centrumafstand doorgetrokken.",
    "Als er slechts één bevestigde zone is, wordt uitsluitend voor de BETA-weergave een ATR-gebaseerde fallbackafstand gebruikt.",
    "De bovenste en onderste ladderzone lopen tot de rand van de zichtbare chart, zodat er geen ongekleurde prijsruimte meer ontstaat.",
    "Zonekleuren zijn semantisch gecorrigeerd: negatieve zones groen, Zone 0 blauw, +1/+2 amber en +3 rood.",
  ],
  now: [
    "Een koers ruim boven de hoogste bevestigde zone wordt niet meer als BALANS gezien maar als een positieve SHORT-bias zone, maximaal Zone +3.",
    "De soldatenknop blijft exact dezelfde server-side capaciteitsactie uitvoeren als in Build 405; alleen de zone die het advies voedt is gecorrigeerd.",
    "STABLE-gebruikers houden de bestaande zoneberekening en weergave; deze fix blijft alleen zichtbaar op het BETA-owner account.",
  ],
  before: "Build 405 introduceerde de werkende koersinstructie en soldatenknop, maar gebruikte nog de dichtstbijzijnde bevestigde zone buiten de bekende banden.",
  after: "Build 406 maakt de BETA-zoneweergave en de instructielogica één consistente volledige prijsindeling.",
  technicalDetails: [
    "Visuele referentie blijft file_00000000d9b081f59f77ecf35043ec32.",
    "Laddergeometrie: bevestigde center-spacing per zone-index; fallback alleen bij onvoldoende centra via ATR/2%-minimum.",
    "Actieve zone wordt bepaald op de halfweggrenzen tussen laddercentra en begrensd op -3 t/m +3.",
    "Geen backend trading-, DCA-, TP-, order- of close-logica is gewijzigd.",
  ],
