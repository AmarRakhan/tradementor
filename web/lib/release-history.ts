...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Portfolio Koers en de Snapshot-enhancers draaien nu binnen dezelfde AuthProvider als de Aster-pagina, zodat useAuthSession nooit buiten zijn context kan renderen.",
    "PWA-updatecontrole is tijdens startup volledig passief: geen automatische reload, replace, skipWaiting-activatie of clients.claim terwijl Firebase de sessie herstelt.",
    "Service-worker updates worden alleen op de achtergrond ontdekt; een draaiende gebruikerssessie wordt niet meer overgenomen.",
  ],
  problems: [
    "Meerdere gebruikers meldden na de Portfolio Koers-releases zwart scherm/spinner en herhaald terugvallen naar Beveiligde sessie controleren.",
    "De fout kon zowel tijdens openen als tijdens handmatig vernieuwen optreden.",
  ],
  causes: [
    "Build 395 voegde useAuthSession toe aan PortfolioKoersChart voor lokale account-history, terwijl AsterPortfolioSnapshotEnhancer in layout.tsx nog buiten AuthProvider stond. Zodra de portal de chart renderde kon de hook dus zonder provider-context uitvoeren.",
    "Tegelijk had de PWA-lifecycle meerdere automatische takeover/navigatiepaden: service-worker activatie en eerdere startup-updatechecks konden het document tijdens Firebase-herstel vervangen.",
    "Build 396 verwijderde een deel van de reloadpaden, maar loste de door Build 395 geïntroduceerde provider-scopefout nog niet op.",
  ],
  fixes: [
    "AuthProvider omvat nu de chart/Snapshot lifecycle en de overige accountgebonden enhancers; portals behouden daardoor de juiste auth-context.",
    "De service worker gebruikt geen clients.claim en geen automatische skipWaiting tijdens installatie.",
    "PwaRegistration registreert en controleert updates alleen passief en bevat geen window.location reload/replace meer.",
    "Regressietests bewaken zowel de AuthProvider-scope van AsterPortfolioSnapshotEnhancer als het ontbreken van automatische PWA-startupnavigatie.",
  ],
  now: [
    "Een appstart kan de chart niet meer laten crashen door ontbrekende AuthProvider-context.",
    "Een nieuwe service worker kan een reeds draaiende sessie niet meer tijdens startup overnemen of herladen.",
  ],
  before: "Build 395 kon de chartportal buiten AuthProvider renderen; daarnaast kon de PWA-updateflow het document tijdens sessieherstel opnieuw laden.",
  after: "Accountgebonden chartcomponenten zitten binnen AuthProvider en PWA-updates zijn tijdens startup volledig non-disruptive.",
  technicalDetails: [
    "Root-cause audit uitgevoerd over Build 392 → 393 → 394 → 395 → 396.",
    "Build 393/394 wijzigden AuthProvider/PWA niet; de provider-contextregressie ontstond in Build 395 toen PortfolioKoersChart useAuthSession ging gebruiken zonder de bestaande mount-scope aan te passen.",
    "Geen trading-, order-, DCA-, hedge-, TP-, leverage- of exchange-executionlogica gewijzigd.",
  ],
