...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    ...
    "Nieuwe HEDGE_LOCK-reservering beschermt de door Auto Hedge toegevoegde quantity tegen normale automatische sluitpaden.",
    "Als de protected leg volledig sluit, blijft de andere zijde bestaan als RECOVERY met een expliciete Opnieuw hedgen-schakelaar.",
    "Het zelfstandige Auto Hedge-scherm volgt visueel file_00000000ecd08246bd1b15532fb478d6 en toont LONG/SHORT onder elkaar.",
  ],
  problems: [
    "Build 430 accepteerde een grotere tegenpositie als volledig gehedged en kon dus netto exposure laten bestaan.",
    "De Build-430 client-order-id kon bij een latere identieke hedgebehoefte opnieuw worden gebruikt.",
    "Een hedge-leg mocht nog niet centraal worden gereserveerd tegen andere TP/close-paden.",
  ],
  causes: [
    "De eerste shadowimplementatie was leg-gebaseerd en kende nog geen persistente pair lifecycle, allocation-reservering of hedgegeneratie.",
  ],
  fixes: [
    "Exact 1:1 reconciliation ondersteunt zowel OPEN van ontbrekende quantity als REDUCE van overdekking en faalt gesloten op exchange-precision.",
    "Iedere nieuwe hedgecyclus krijgt een generationId; retries van dezelfde logische actie behouden dezelfde idempotency-id.",
    "RECOVERY en REHEDGE_ARMED voorkomen automatische hedge-pingpong nadat de oorspronkelijke protected leg is gesloten.",
    "Centrale Aster pre-submit- en close-guards blokkeren consumptie van HEDGE_LOCKED quantity; accountbrede emergency Close All blijft de expliciete override.",
    "Tradecentrum toont een compacte Auto Hedge-status zonder het bestaande Tradecentrum te herontwerpen.",
  ],
  now: [
    "Bestaande locks blijven bewaakt wanneer de globale Auto Hedge-schakelaar wordt uitgezet; alleen nieuwe triggers stoppen.",
    "Production Auto Hedge orderexecutie blijft tijdens Build 431 expliciet UIT totdat de technische en accountaudit volledig is goedgekeurd.",
  ],
  before: "Build 430 leverde de eerste owner-only read-only/shadow Auto Hedge-test op.",
  after: "Build 431 voegt de volledige exact-1:1 lifecycle en het definitieve mobiele beheerscherm toe, nog steeds zonder live Auto Hedge-orders.",
  technicalDetails: [
    "Primaire UI-reference: file_00000000ecd08246bd1b15532fb478d6.",
    "Pair-state wordt per symbol persistent vastgelegd onder asterPositionLossAutoHedge/{uid}/pairs.",
    "Exchange position_risk en open_orders blijven de operationele source of truth.",
    "ASTER_POSITION_LOSS_AUTO_HEDGE_EXECUTION_ENABLED blijft false.",
  ],
