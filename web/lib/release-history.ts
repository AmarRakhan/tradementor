...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  title: "Auto Hedge · per positie 1:1 op dollarverlies",
  newItems: [
    "Nieuwe AUTO HEDGE-tegel tussen Profit Sparen en Portfolio Cyclus met persisted AAN/UIT-status en ingestelde dollarverliesgrens.",
    "Dubbel tikken/klikken flipt de bestaande Portfolio Snapshot 3D naar de Auto Hedge-instellingen.",
    "Nieuwe geïsoleerde Position Loss Auto Hedge-engine vergelijkt per exchange-leg open P&L en vult uitsluitend ontbrekende tegen-quantity aan tot 1:1.",
  ],
  problems: [
    "De eerder gebouwde portfolio-gebaseerde noodhedge was ongeschikt als basis voor de simpele per-positie verliesregel en is al globaal uitgeschakeld.",
  ],
  causes: [
    "Portfolio-drawdown/high-water/recovery-logica heeft een andere semantiek dan de gewenste individuele positie-trigger.",
  ],
  fixes: [
    "Nieuwe businesslogica is geïsoleerd van de oude portfolio-hedge-engine en gebruikt Aster position_risk als source of truth.",
    "Bestaande tegengestelde quantity en pending open-orders tellen mee; alleen het ontbrekende verschil wordt aangevuld.",
    "Restart/reconcile, partial-fill delta, server-side worker, persisted status en auditlogging zijn toegevoegd.",
    "Visuele binding is vastgelegd tegen file_00000000340881f4b05212f7cfd82727 en file_00000000ee58820abf41140132367883.",
  ],
  now: [
