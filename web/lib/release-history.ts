...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Prijszones worden nu vóór de opaque chart-canvas gerenderd, zodat de rood/amber/groen/blauwe prijscontext daadwerkelijk zichtbaar is.",
    "Maximaal drie volledige eventlabels en maximaal twee compacte clusters tegelijk.",
    "Per candle wordt standaard nog maar één kleine prioriteitsmarker getekend; hover/tap behoudt alle bevestigde eventdetails.",
  ],
  problems: [
    "Build 398 berekende zones correct, maar de zone-overlay stond met z-index 1 achter de chart-canvas op z-index 2 en was daardoor visueel grotendeels verborgen.",
    "Bij veel handmatige acties kon de combinatie van vijf hoofdlabels, meerdere clusters en alle losse series-markers de chart nog te druk maken.",
  ],
  causes: [
    "De overlayvolgorde maakte de dynamische zonekleuren onzichtbaar achter de opaque chartachtergrond.",
    "De eerste declutter-pass beperkte alleen volledige labels en niet het totale aantal compacte clusters en kleine series-markers.",
  ],
  fixes: [
    "Zone-overlay naar z-index 4 gebracht en de tinten lichter gemaakt zodat candles en Bollinger leidend blijven.",
    "De marker-layout is begrensd op drie hoofdlabels en twee clusters met count-preserving overflow merge.",
    "Series-markers worden per candle geconsolideerd op hoogste eventprioriteit; individuele events blijven ongewijzigd in de payload en tooltip.",
    "Gridlijnen en eventboxen zijn subtieler gemaakt; timeframe-context is op mobiel beter leesbaar.",
  ],
  now: [
    "De achtergrondzones zijn zichtbaar en veranderen mee met de gekozen timeframe omdat ze uit de bestaande timeframe-zones worden geprojecteerd.",
    "Drukke handmatige handelsperiodes blijven leesbaar zonder eventdata te verwijderen.",
    "Trading-, order-, DCA-, hedge-, TP-, leverage-, auth-, PWA-, polling- en backendlogica zijn niet gewijzigd.",
  ],
  before: "Build 398 had correct berekende zones achter de canvas en kon bij veel events nog meerdere visuele lagen tegelijk tonen.",
  after: "Build 399 toont de zonekleuren daadwerkelijk boven de chartcanvas en beperkt de standaard eventweergave tot maximaal drie hoofdlabels en twee compacte clusters.",
  technicalDetails: [
    "Display-only scope: portfolio-koers-chart.tsx, portfolio-koers-chart.css, pure marker-layouthelper, tests en release/version metadata.",
    "Onderliggende payload, API-route, realtime-equitymerge, pollinginterval, Snapshot-equity en tradinguitvoering zijn intact gelaten.",
  ],
