...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Portfolio Koers opent standaard als cashflow-gecorrigeerde performance en houdt de echte Aster accountwaarde beschikbaar als aparte weergave.",
    "Stortingen en opnames krijgen eigen compacte markers en worden niet meer visueel als tradingwinst of tradingverlies gepresenteerd.",
    "Zone-Soldaten Strategiestatus toont actuele strategy-owned LONG/SHORT posities, oude-zone posities en live afstand tot de volgende zones.",
    "Portfolio Cyclus en Auto Hedge zijn in Portfolio Snapshot compacter gemaakt zonder dubbele configuratie-informatie.",
  ],
  problems: [
    "Raw equity sprong bij stortingen/opnames en maakte de grafiek daardoor moeilijk als performancegrafiek te lezen.",
    "Losse zwaard- en TP-iconen bedekten op mobiel een groot deel van de grafiek.",
    "Thuis/beschikbaar en Volgende mogelijke instroom legden engine-informatie nadrukkelijker uit dan de actuele strategiepositie.",
    "Een onbekende soldier-cost kon in de Command Center UI ten onrechte als onvoldoende Available worden weergegeven.",
  ],
  causes: [
    "De oude Portfolio Koers visualiseerde raw account equity en strategyzones op dezelfde hoofdweergave en behandelde een onbekende affordability-berekening als false.",
  ],
  fixes: [
    "Performance en Accountwaarde zijn expliciet gescheiden; raw strategyzone-overlays worden niet op de adjusted performance-as getekend.",
    "Trade-events worden per candle geaggregeerd naar compacte L/S/TP chips en cashflows blijven een aparte categorie.",
    "Server-side Zone-Soldaten rapportage publiceert exact strategy-owned en current/old-zone subsets zonder legacy/manual ownership te gokken.",
    "Available-diagnostiek is tri-state: ENOUGH, NOT_ENOUGH of UNKNOWN; UNKNOWN mag niet meer als onvoldoende Available worden gelabeld.",
    "Dagperformance publiceert cashflow breakdown en weigert historische TWR-precisie te verzinnen wanneer intraday snapshots ontbreken.",
  ],
  now: [
    "De tradingengine blijft ongewijzigd op zijn bestaande raw strategy source of truth; de performancecorrectie is een visualisatie-/auditlaag.",
    "Snapshot toont Rendement vandaag expliciet exclusief stortingen en opnames.",
  ],
  before: "Build 431 leverde Auto Hedge 2.0 met exact 1:1 lifecycle, recovery en rehedge.",
  after: "Build 432 maakt Portfolio Koers en Strategiestatus veel rustiger en financieel beter interpreteerbaar zonder tradingregels te wijzigen.",
  technicalDetails: [
    "Primaire references: file_000000005ba0820a945df343134caea9 en file_00000000cf9481f4b495250734661e31.",
    "Performance view neutraliseert signed external cashflow; Accountwaarde behoudt raw exchange equity, BB en strategyzones.",
    "Exacte intraday TWR wordt alleen gerapporteerd wanneer voldoende subperiod snapshots bestaan.",
  ],
