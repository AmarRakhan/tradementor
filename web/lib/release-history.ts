...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  now: [
    ...
    "Als dezelfde formatie later in Zone +1 tien vrije SHORT-stoelen heeft, adviseert de balk vijf ongebruikte SHORT-soldaten naar huis te roepen.",
    "De knop opent of sluit geen exchange-positie rechtstreeks: hij wijzigt de echte stoelcapaciteit, waarna de bestaande Bollinger-, slot- en entryvoorwaarden bepalen of vrije stoelen gevuld worden.",
    "STABLE-gebruikers houden de Build 404-weergave en krijgen deze BETA-laag niet te zien.",
  ],
  before: "Build 404 maakte de stoelbezetting in Botconfigurator V2 semantisch gelijk aan de live LONG/SHORT-bezetting.",
  after: "Build 405 maakt die live stoeldata vanuit Portfolio Koers actiegericht zonder automatische zone-orders of geforceerde sluitingen.",
  technicalDetails: [
    "Visuele referentie: file_00000000d9b081f59f77ecf35043ec32.",
    "Account-gate: /api/releases/me moet channel=BETA en bot_configurator_v2.enabled=true teruggeven.",
    "Actie-endpoint: PUT /api/exchanges/aster/strategy2/settings; geen order-, close- of market-order endpoint wordt door de knop aangeroepen.",
    "Zoneadvies is deterministisch: abs(zoneIndex) × 5 vrije stoelen op LONG bij negatieve zones of SHORT bij positieve zones; Zone 0 behoudt de bestaande formatie.",
  ],
