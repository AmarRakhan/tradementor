...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Elke zone is nu één ondubbelzinnig horizontaal kleurvlak; aangrenzende negatieve en positieve zones krijgen onderling verschillende tintsterktes.",
    "Echte zonegrenzen worden als één aparte structurele lijn getekend in plaats van dubbele randen op ieder zonevlak.",
    "De directe grens omhoog en omlaag vanuit de actieve zone wordt extra gemarkeerd met VOLGENDE ↑/↓ en de exacte portfolio-waarde.",
    "De koersinstructie toont nu naast gewenst/huidig ook de reden van het advies en de eerstvolgende omslaglevels.",
  ],
  problems: [
    "Meerdere groene zones konden visueel als één massa lezen en dubbele zone-randen leken op willekeurige extra horizontale lijnen.",
    "De actieve zone was onvoldoende dominant en gewone gridlijnen concurreerden visueel met echte zonegrenzen.",
    "Formatie klopt · geen actie nodig gaf onvoldoende uitleg en liet niet zien bij welk niveau het advies zou veranderen.",
  ],
  causes: [
    "Zonevakken droegen zelf boven- en onderranden en meerdere signed zones deelden dezelfde fillkleur.",
    "De instructiebalk had wel huidige en gewenste stoelen, maar nog geen expliciete reden of volgende boven-/ondergrens.",
  ],
  fixes: [
    "BETA-zonevakken zijn borderloos; een aparte boundary-layer tekent iedere echte grens exact één keer.",
    "Zone -3/-2/-1, Zone 0 en Zone +1/+2/+3 hebben nu onderscheidende donkere premium fills; de actieve zone krijgt extra brightness en een subtiele interne highlight.",
    "De gewone chart-grid wordt alleen in de BETA decision-map verder gedimd; Bollinger-lijnen blijven ongewijzigd herkenbaar als bewegende indicatoren.",
    "De eerstvolgende grens omhoog is goud geaccentueerd, de eerstvolgende grens omlaag groen; beide tonen hun exacte triggerwaarde.",
    "Voor iedere functionele soldatenklik wordt de canonieke 15m zone opnieuw opgehaald en de actuele zone opnieuw bevestigd vóór de server-side stoelwijziging.",
  ],
  now: [
    "De gebruiker ziet direct: huidige bias/zone, gewenste formatie, eerstvolgende grens omhoog en omlaag en de reden waarom nu wel of geen soldatenactie nodig is.",
    "De linkerboven-badge vat status, actieve zone en gewenste LONG/SHORT-verdeling samen zonder losse zone-tekstlabels in de grafiek.",
    "De soldatenknop blijft uitsluitend longSlots, shortSlots en maximumPositions server-side aanpassen; geen directe order en geen geforceerde close.",
    "De wijziging blijft uitsluitend zichtbaar en functioneel voor het BETA-owner account.",
  ],
  before: "Build 407 maakte de strategische zonekaart timeframe-onafhankelijk met één canonieke 15m-zonebron.",
  after: "Build 408 maakt diezelfde stabiele zonekaart visueel en inhoudelijk bruikbaar als beslissingskaart.",
  technicalDetails: [
    "Nieuwe helper: portfolioZoneContextFromLadder levert activeIndex, upper/lowerBoundary en volgende zone-indexen.",
    "Volgende triggers worden afgeleid uit exact dezelfde canonieke ladder die ook de zonefills en soldateninstructie voedt.",
    "Voor de knop wordt vlak voor PUT /strategy2/settings opnieuw de 15m canonical payload opgehaald en freshZone berekend.",
    "Geen backend trading-, DCA-, TP-, order- of close-logica gewijzigd.",
  ],
