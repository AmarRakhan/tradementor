...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "Botinstellingen zijn visueel samengebracht in een compact premium mobiel overzicht met duidelijke slot-bezettingsbalken.",
    "Maximum leverage kan optioneel als bovengrens voor nieuwe posities worden ingesteld.",
    "Nieuwe server-side Stoploss kan afzonderlijke LONG- en SHORT-grenzen in USDT of procent gebruiken.",
  ],
  problems: [
    "De Botinstellingen namen meerdere mobiele schermen in beslag en capaciteit versus actuele bezetting was moeilijk direct te lezen.",
    "Minimum leverage bepaalde wel welke pairs in aanmerking kwamen, maar een geschikte pair kon daarna automatisch op zijn veel hogere exchange-maximum openen.",
    "Er was geen expliciete per-trade verliesgrens die ook zonder geopende telefoon server-side een volledige positie kon sluiten.",
  ],
  causes: [
    "Capaciteit, bezetting en vrije slots stonden als losse cijfers in twee regels in plaats van één visueel slot-overzicht.",
    "De bestaande leverage-resolver koos bewust de hoogste geldige exchange-leverage en kende nog geen optionele gebruikerscap.",
    "De execution pipeline bevatte TP-, DCA- en beschermingslogica maar nog geen expliciet geconfigureerde verlies-exit vóór die acties.",
  ],
  fixes: [
    "Het bovenste Botinstellingenblok gebruikt nu LONG-, SHORT- en totaalbalken met bezet/capaciteit/vrij, plus CROSS en kandidaten in één kaart.",
    "Maximum leverage is backward-compatible: ontbrekend of leeg behoudt de bestaande pair-maximumlogica; een ingestelde cap begrenst alleen nieuwe entries en moet minimaal gelijk zijn aan Minimum leverage.",
    "Stoploss draait server-side vóór Portfolio TP, Profit Lock, Smart Rescue, normale TP, DCA en refill; verlies-exits zijn idempotent, reduce-only via de bestaande sluitinfrastructuur en worden opnieuw met exchange truth gesynchroniseerd.",
  ],
  now: [
    "De primaire Botinstellingen zijn veel compacter en sluiten aan op de goedgekeurde emerald/goud/roze mobiele referentie.",
    "Een pair met 300x maximum en instellingen Minimum 50 / Maximum 75 opent nieuwe exposure maximaal op 75x; zonder Maximum blijft het oude gedrag behouden.",
    "Wanneer Stoploss aan staat, kan LONG of SHORT op de ingestelde USDT- of procentgrens volledig server-side worden gesloten, ook als de webapp niet geopend is.",
  ],
  before: "Botinstellingen waren verspreid over meerdere schermhoogtes, leverage had alleen een minimumfilter en er was geen configureerbare server-side Stoploss.",
  after: "Eén compacte mobiele instellingenflow toont slotbezetting direct en voegt optionele Maximum leverage en een server-side Stoploss toe zonder bestaande instellingen opnieuw te bouwen.",
  technicalDetails: [
    "Visuele doelreferentie: file_00000000d2ec81f4b0c6fe6b9befe97c (941 × 1672).",
    "Stoploss-procent gebruikt dezelfde ongeleveragede entry/mark-prijsbasis als de bestaande per-trade TP-drempel; USD gebruikt de exchange unrealized PnL wanneer beschikbaar.",
    "Stoploss staat voor bestaande gebruikers standaard uit; Maximum leverage blijft voor bestaande accounts unset en veroorzaakt daardoor geen onverwachte leverage-cap.",
    "Nieuwe regressietests dekken leverage-caps, grenswaarden van LONG/SHORT Stoploss, partial fills, duplicate evaluation, open-order guards, gekoppelde hedge-cycles en execution-prioriteit.",
  ],
