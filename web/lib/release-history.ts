...
export const CURRENT_RELEASE: ReleaseHistoryEntry = {
  ...
  newItems: [
    "LONG- en SHORT-events gebruiken nu duidelijk gekruiste zwaarden met een afzonderlijk verdiept ×n-badgeje eronder.",
    "Take Profit gebruikt het geldzak-icoon met een eigen TP-badge zoals in de goedgekeurde referentie.",
    "Marker en candle worden verbonden met een subtiele gestippelde connector en een kleine gekleurde ankerdot.",
    "Bevestigde portfolio-S/R-zones worden visueel verbreed tot horizontale regio's tussen echte zonecentra, met rood/amber/groen/blauw zoals in de referentie.",
    "De mobiele chart is hoger gemaakt zodat de koers, Bollinger Bands en markers dezelfde rustige verticale ruimte krijgen als het goedgekeurde ontwerp.",
  ],
  problems: [
    "Het soldaat-icoon uit Build 400 was te onduidelijk.",
    "De echte zonebanden waren correct maar zo smal dat de chart visueel niet overeenkwam met de goedgekeurde referentie.",
  ],
  causes: [
    "Build 400 gebruikte een generiek schaak/soldaat-symbool en renderde uitsluitend de smalle ATR-breedte rondom elk bevestigd S/R-niveau.",
    "De referentie gebruikt duidelijke symboolkaarten en brede horizontale waardegebieden tussen niveaus.",
  ],
  fixes: [
    "Gekruiste zwaarden vervangen het soldaat-symbool; kleur blijft groen voor LONG en rood voor SHORT.",
    "De ×n/TP-badge heeft een eigen border, gradient, inset-highlight en schaduw zodat hij niet als plat tekstgetal oogt.",
    "Zone-regio's worden uitsluitend uit de bestaande bevestigde zonecentra en de echte buitenste zonegrenzen afgeleid; er worden geen statische of verzonnen prijsniveaus toegevoegd.",
    "De marker-layout blijft de echte Bollinger-envelope respecteren; labels blijven erbuiten.",
  ],
  now: [
    "De chart volgt visueel referentie file_00000000dd24820eaa6e54ec1054904f.",
    "Rood/amber/groen/blauw zijn echte Portfolio Koers-waarderegio's in USDT, niet BTC/ETH-prijsniveaus.",
    "Backend zone-detectie, candles, event timestamps/counts, notional, PnL, polling, realtime equity en tradinguitvoering zijn ongewijzigd.",
  ],
  before: "Build 400 had veilige maar te abstracte soldaat-iconen en smalle echte S/R-zonebanden.",
  after: "Build 401 toont gekruiste zwaarden, verhoogde badges, connectors en brede kleurregio's die uitsluitend uit echte bevestigde portfolio-zones zijn afgeleid.",
  technicalDetails: [
    "Primaire visuele referentie: file_00000000dd24820eaa6e54ec1054904f.",
    "Zonebron blijft confirmed-swings+sr-cluster+atr; alleen de frontend projecteert de confirmed centers naar bredere visuele regio's tussen aangrenzende niveaus.",
    "Display-only scope: Portfolio Koers component/CSS, pure marker-layouthelper, regressietests en release/version metadata.",
    "Geen cloud_api-, API-, polling-, auth-, PWA-, Portfolio Snapshot-, order-, DCA-, hedge-, TP-, leverage- of exchange-executioncode gewijzigd.",
  ],
