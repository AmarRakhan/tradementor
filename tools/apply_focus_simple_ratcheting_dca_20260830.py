...
# Keep audit/response diagnostics on the renamed trailing DCA value.
text = text.replace('nextDca=next_fixed_dca', 'nextDca=next_dca_after_fill', 1)
text = text.replace('"nextDcaPrice": next_fixed_dca', '"nextDcaPrice": next_dca_after_fill', 1)
