...
def aster_status(user: dict[str, Any] = Depends(authenticated_user)) -> dict[str, Any]:
    ...
    if v2_symbol and str(v2_state.get("cycleId", "")):
        ...
        elif state_machine_version>=6 and short_qty>0 and release_ready: next_action=f"HERSTEL +{strategy2_settings.focus_v2_hedge_release_recovery_pct*100:.2f}% · SHORT VOLLEDIG LOSLATEN"
