...
def aster_status(user: dict[str, Any] = Depends(authenticated_user)) -> dict[str, Any]:
    ...
    if v2_symbol and str(v2_state.get("cycleId", "")):
        ...
        elif state_machine_version>=6 and short_qty>0 and bool(v2_state.get("shortReleasePriceReady")) and bool(v2_state.get("shortReleaseNetGreenReady")): next_action=f"RELEASE READY · +{strategy2_settings.focus_v2_hedge_release_recovery_pct*100:.2f}% EN SHORT NETTO GROEN"
