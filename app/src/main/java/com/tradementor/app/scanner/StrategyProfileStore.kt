...
object StrategyProfileStore {
    ...
    val definitions = listOf(
        StrategyDefinition("strategy_1", "TradeMentor Core", true, true, summary = "Onze bewezen technische selectie"),
        StrategyDefinition(
            "strategy_2",
            "Quantum Shield",
            defined = true,
        ...
        StrategyDefinition("strategy_3", "Momentum Rush", false, false),
    ...
    fun activeDefinition(context: Context): StrategyDefinition =
        definitions.firstOrNull { it.id == activeStrategyId(context) } ?: definitions.first()
